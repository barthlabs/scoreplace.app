...
| L9 | código morto, fallbacks e aliases | **Em execução. L9.P0 concluída em 11/set:** três aliases globais sem chamador foram removidos; aliases com leitor, dado histórico ou rota ainda ativa foram preservados. | Prova de ausência de chamadores antes de remover compatibilidade. |
