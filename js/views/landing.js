...
(function() {
  ...
  function _css() {
    ...
    '.landing-cta-btn { display: block; width: 95%; max-width: 760px; margin-left: auto; margin-right: auto; box-sizing: border-box; font-size: clamp(1.05rem, 1.4vw + 0.85rem, 1.55rem); font-weight: 800; padding: clamp(14px, 2vh + 6px, 26px) clamp(16px, 4vw, 48px); border-radius: 14px; cursor: pointer; background: #047857; letter-spacing: 0.3px; box-shadow: 0 6px 0 #035c43, 0 9px 18px rgba(4,120,87,0.3), inset 0 2px 0 rgba(255,255,255,0.35), inset 0 -3px 6px rgba(0,0,0,0.15); }' +
    '.landing-cta-btn:active { transform: translateY(5px); box-shadow: 0 1px 0 #035c43, 0 2px 6px rgba(4,120,87,0.3), inset 0 2px 0 rgba(255,255,255,0.3); }' +
