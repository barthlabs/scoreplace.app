...
function renderDashboard(container) {
  ...
  function _buildMyResultsHtml() {
    ...
    function _miniBracketCard(item, canLaunch) {
      ...
      function _playerRow(name, uid) {
        ...
        var _interno = uid && typeof window._personNameHtml === 'function'
          ? window._personNameHtml(uid, _disp)
          : '<span' + _uidAttr + '>' + _sf(_disp) + '</span>';
  ...
  const html = `
    ...
    ">
      ...
      <!-- A versão saiu daqui (03/set/2026): agora mora sob o wordmark do cabeçalho, que
           aparece em TODAS as telas — e não só nesta. Ver #header-version no index.html. -->
