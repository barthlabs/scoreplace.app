...
function renderDashboard(container) {
  ...
  const html = `
    ...
    ">
      ...
      <div style="text-align:center;margin-bottom:8px;font-size:0.75rem;color:var(--hero-text-soft);font-weight:600;letter-spacing:0.5px;">v${window.SCOREPLACE_VERSION || ''}${window._bootRevealInfo ? ' · abertura: ' + window._bootRevealInfo.label + ' @ ' + window._bootRevealInfo.elapsedMs + 'ms' : ''}</div>
