  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🏆 Abrir o torneio leva ao torneio, não à lista de inscritos:</b> um torneio que <b>já tinha gente inscrita mas ainda não foi sorteado</b> abria despejando a lista inteira de participantes no topo — empurrando as <b>Ferramentas do Organizador</b>, e com elas o botão de <b>Sortear</b>, para baixo de tudo. Agora o detalhe é sempre o mesmo: informações, ferramentas e a chave. A lista de inscritos, com busca, filtros e chamada, abre pelo botão <b>👥 Inscritos</b>.</li>' +
