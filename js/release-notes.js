  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>📐 Convites pendentes ocupam a tela toda:</b> a lista de convites enviados vinha numa coluna só, esticada, enquanto seus amigos logo acima já se dividiam em várias. Agora as duas usam o mesmo formato — em tela larga, 2, 3 ou 4 colunas. E o ✕ de desfazer amizade, que era cinza e quase invisível, virou o mesmo círculo vermelho de cancelar do resto do app.</li>' +
