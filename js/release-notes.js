// 2.3.51 — entrega web da geometria única dos cards: a distância vertical entre integrantes de uma dupla é a mesma em Novidades, Próximo Jogo, Últimos Resultados e chave.
  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🎾 Cards de jogo com a mesma geometria:</b> a distância entre os dois integrantes de uma dupla passa a seguir a mesma medida em Novidades, Próximo Jogo, Últimos Resultados e chave do torneio. Nomes longos continuam usando as duas linhas reservadas sem afastar os integrantes.</li>' +
