  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🔎 O Explorar virou uma tela de verdade:</b> agora ele abre a lista de <b>todos os torneios da plataforma</b> — não só os que já apareciam pra você — com nome, modalidade, local, data, formato e nº de inscritos, mais a barra de ordenar, filtrar e buscar. Torneios privados não são listados; a tela só indica quantos ficaram de fora.</li>' +
