  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🏆 Placar, classificação e W.O. voltaram a aparecer:</b> em torneios grandes, a tela podia abrir com <b>tudo zerado</b> — classificação em 0, "Demais jogos da rodada (0)", W.O. e jogadores inativos sumidos. Nada disso tinha se perdido: os jogos e os placares seguiram guardados o tempo todo. O app checava se já tinha os jogos perguntando apenas <b>se existia algum</b> — e bastava um único registro solto para ele concluir que já tinha todos e parar de buscar os outros. Agora ele confere <b>quantos</b> deveria ter.</li>' +
