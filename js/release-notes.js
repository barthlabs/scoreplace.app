  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>⚖️ Novo critério de desempate — saldo de pontos de tie-break:</b> até aqui a classificação olhava o saldo de <b>games</b> e quantos tie-breaks a pessoa venceu, mas nunca o placar <b>dentro</b> do tie-break: perder por 5-7 valia o mesmo que perder por 0-7. Agora, empatado o resto, quem fez mais pontos de tie-break fica na frente — e isso entra <b>antes do sorteio</b>, então há menos empate decidido pela ordem da chave.</li>' +
