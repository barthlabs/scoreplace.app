...
window._RELEASE_NOTES_HTML = (function () {
  var html =
    '<div style="margin-bottom:1rem;border:2px solid #34d399;border-radius:12px;padding:14px 16px;background:rgba(16,185,129,0.07);">' +
      '<div style="font-weight:800; color:#6ee7b7; font-size:1rem; margin-bottom:8px;">🏷️ v2.4.59-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(13 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>W.O. da Liga mais claro na chave.</b> Quando alguém leva W.O. e um jogador de folga é convidado pra entrar no lugar, o grupo agora mostra isso <b>na própria chave</b>: o ausente aparece <b>riscado com a marca "W.O."</b> e uma faixa indica <b>"[convidado] foi convidado — aguardando confirmação"</b>. Antes a troca só acontecia depois que o convidado aceitava, e até lá nada aparecia nos jogos.</li>' +
