  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🗂️ Torneio novo volta a nascer no formato novo de armazenamento:</b> desde a mudança da estrutura de dados, os torneios criados ainda nasciam no formato antigo, com tudo dentro de um único registro. Uma tentativa anterior de corrigir isso <b>impedia salvar o torneio</b> e foi desfeita. A causa foi encontrada e é de uma linha só. Na prática: torneios novos deixam de ter teto de tamanho e abrem mais rápido — e nenhum torneio existente muda.</li>' +
