  ...
  var html =
    '<div style="margin-bottom:1rem;border:2px solid #6366f1;border-radius:12px;padding:14px 16px;background:rgba(99,102,241,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>Menos bugs pra você:</b> agora conseguimos testar mudanças num <b>espelho privado do torneio real</b>, que roda exatamente o mesmo código, sem disparar nenhuma notificação nem afetar seus dados ou suas estatísticas. Assim pegamos os problemas antes que cheguem em você.</li>' +
      '</ul>' +
    '</div>' +
    ...
    '<div style="margin-bottom:1rem;border:2px solid #f59e0b;border-radius:12px;padding:14px 16px;background:rgba(245,158,11,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Cada jogo guarda a identidade da pessoa, não o nome:</b> o sorteio agora carimba o identificador de cada jogador em <b>todos</b> os jogos — a 1ª rodada inclusive. Assim, se alguém muda o nome no perfil, os jogos continuam certos (antes, em alguns casos, o nome podia ficar velho ou trocar com um homônimo).</li>' +
      '</ul>' +
    '</div>' +
    ...
    '<div style="margin-bottom:1rem;border:2px solid #25D366;border-radius:12px;padding:14px 16px;background:rgba(37,211,102,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>⚡ Automático ao salvar:</b> quando o organizador salva o link do grupo, todos os inscritos já são avisados na hora. O botão serve pra reenviar (ex.: pra quem se inscreveu depois).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:2px solid #6366f1;border-radius:12px;padding:14px 16px;background:rgba(99,102,241,0.08);">' +
