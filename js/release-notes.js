...
window._RELEASE_NOTES_HTML = (function () {
  var html =
    '<div style="margin-bottom:1rem;border:2px solid #34d399;border-radius:12px;padding:14px 16px;background:rgba(16,185,129,0.07);">' +
      '<div style="font-weight:800; color:#6ee7b7; font-size:1rem; margin-bottom:8px;">🏷️ v4.0.12-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(27 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🏟️ Logo do local:</b> ao cadastrar/editar um local em Locais, agora tem a mesma seção de <b>logo do torneio</b> — gerar com IA, enviar arquivo, ajustar a forma (círculo↔quadrado), travar e baixar. O logo fica salvo no local.</li>' +
