...
window._RELEASE_NOTES_HTML = (function () {
  var html =
    '<div style="margin-bottom:1rem;border:2px solid #34d399;border-radius:12px;padding:14px 16px;background:rgba(16,185,129,0.07);">' +
      '<div style="font-weight:800; color:#6ee7b7; font-size:1rem; margin-bottom:8px;">🏷️ v4.3.23-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(3 de Julho, 2026)</span></div>' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v4.3.18-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(2 de Julho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>👑 Rei/Rainha da Praia mais consistente por dentro:</b> o Rei/Rainha passou a rodar 100% pelo mesmo <b>motor de fases</b> dos outros formatos — ele é um <b>modo de sorteio</b> do Pontos Corridos, não um formato separado. Nada muda no seu uso; a mudança deixa o app mais estável e evita bugs de tela ao montar e avançar torneios com Rei/Rainha.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v4.3.17-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(2 de Julho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>👁 Ver a fase anterior sem perder a atual:</b> um botão revela os <b>resultados e chaves</b> das fases já encerradas <b>sem esconder</b> a fase em andamento. E a <b>tabela de classificação</b> de cada grupo aparece sempre <b>acima</b> das chaves.</li>' +
        '<li><b>🏆 Nome certo das rodadas:</b> a barra de progresso mostra <b>Oitavas de Final, Quartas de Final, Semifinais e Final</b> no lugar de "Rodada N".</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v4.3.2-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(2 de Julho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🔧 Motor de torneios mais consistente:</b> melhorias internas no sorteio e nas fases — a primeira fase passa pelo mesmo motor das seguintes, dando mais consistência entre os formatos.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v4.0.39-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(28 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>💬 Enquete — toque no inscrito pra falar no WhatsApp:</b> na tela de <b>Votos (nominal)</b>, o organizador pode <b>tocar no nome de qualquer inscrito</b> (que tenha telefone cadastrado) pra abrir o <b>WhatsApp com uma mensagem pessoal já pronta</b> — ótimo pra combinar o voto, confirmar presença ou tirar dúvida direto. Quem tem número aparece com um 💬 no chip.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v4.0.38-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(28 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📊 Enquete — opções coloridas por seção:</b> na tela de <b>Votos (nominal)</b>, além da opção <b>vencedora em verde</b>, as demais opções ganham um box que <b>alterna a cor por pergunta</b>: a 1ª pergunta fica <b>âmbar</b>, a 2ª <b>azul</b>, a 3ª âmbar de novo, e assim por diante.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v4.0.37-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(28 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📊 Enquete — quem ficou fora da maioria fica em vermelho:</b> na tela de <b>Votos (nominal)</b> (organizador), quem votou numa opção que <b>não é a mais votada</b> agora aparece com o <b>nome em vermelho</b>. Vale pra enquetes de escolha única e de múltipla escolha (ex.: votação de data).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>📍 Nome do local não corta mais:</b> nos cards de Locais, o nome do local agora fica em <b>linha cheia, alinhado à esquerda</b> (mesma margem do logo) e <b>quebra linha em vez de truncar</b> — nomes longos aparecem inteiros.</li>' +
        '<li><b>📸 Foto do local volta a aparecer no card:</b> a foto do Google do local (fundo do card de torneio) parava de carregar com o tempo porque o link do Google <b>expira</b>. Agora o app <b>re-busca a foto na hora</b> pelo local pinado — fundo do card volta a mostrar a foto, sem depender de GPS.</li>' +
        '<li><b>🏟️ Logo do local ao lado do logo do torneio:</b> na página do torneio, quando o local cadastrado tem logo, ele aparece <b>à direita da data</b> (na dashboard) e <b>à direita do box do Local</b> (no detalhe) — sem espremer o nome.</li>' +
        '<li><b>🏟️ Logo do local:</b> ao cadastrar/editar um local em Locais, agora tem a mesma seção de <b>logo do torneio</b> — gerar com IA, enviar arquivo, ajustar a forma (círculo↔quadrado), travar e baixar. O logo <b>aparece nos cards e na ficha do local</b>.</li>' +
        '<li><b>👤 Jogadores sem nome viram "Jogador 1/2/3/4":</b> em toda a Partida Casual, quem não tem conta nem nome digitado aparece como <b>Jogador 1, 2, 3 e 4</b> (por posição, igual pra todos) — fim do "Parceiro/Adversário 1/Adversário 2".</li>' +
        '<li><b>📐 Tamanhos do placar se distribuem na tela:</b> aumentar <b>Nomes/Foto</b> agora <b>cresce o box dos jogadores</b> (sem cortar) e encolhe os outros elementos proporcionalmente — você ajusta a distribuição na tela do jeito que preferir.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.72-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>⚠️ "Faltou alguém?" pros próprios jogadores — em qualquer formato:</b> em torneios que acontecem em <b>mais de um dia</b> e onde <b>os jogadores lançam o resultado</b>, agora qualquer jogador pode apontar uma falta (W.O.) — em <b>eliminatória, fase de grupos, liga ou Rei/Rainha</b>, não só na liga. O <b>outro lado confirma ou contesta</b> antes do W.O. valer; se contestar, o organizador decide.</li>' +
        '<li><b>Como o W.O. é resolvido:</b> na <b>eliminatória</b>, entra um substituto da lista de espera (se houver) ou o adversário avança; na <b>liga/grupos</b>, segue o fluxo de substituição de sempre (convidar folga / Jogador X).</li>' +
        '<li><b>📅 Rei/Rainha: um único "Combinar jogos" por grupo</b> — os 3 jogos do grupo (mesmas 4 pessoas) combinam uma data só, num botão no topo do grupo, ao lado do "Faltou alguém?".</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.70-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🕒 "Atualizado em" correto ao editar:</b> ao editar um torneio (data, local, etc.), o carimbo de "Atualizado em" passa a marcar o <b>momento da edição</b> — antes mostrava a hora de uma ação anterior e parecia fuso errado.</li>' +
        '<li><b>🗺️ Voltar do Google Maps funciona:</b> ao abrir um local no Google Maps e voltar, não fica mais <b>tela branca</b> — os links externos (Maps, WhatsApp, adicionar à agenda) abrem direto. Corrige um comportamento do app instalado no iPhone.</li>' +
        '<li><b>❤️ Coração nos locais preferidos:</b> na tela de Locais, cada preferido mostra um <b>coração</b> ao lado do nome — toque para tirar dos preferidos.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.59-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.53-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>📍 Ficha do local melhor:</b> botões <b>Voltar / Editar / Reivindicar</b> travados no topo ao rolar, e um <b>coração de preferido</b> ao lado do nome — tocar adiciona/remove o local dos seus preferidos.</li>' +
        '<li><b>🗓️ Aviso de "ida planejada" na hora certa:</b> o aviso só aparece quando o torneio está a <b>até 24h</b> — antes pipocava pra eventos a dias de distância.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.48-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🔎 Busca/filtro também na formação de duplas:</b> a barra de buscar e ordenar inscritos (A-Z, mais recentes, gênero, categoria) agora aparece também na tela de montar as duplas — onde ficam "Sem dupla" e "Duplas formadas". Antes ela faltava só ali.</li>' +
        '<li><b>📊 Botão de enquete em destaque:</b> o botão "Ver enquete / Responder enquete" no card do torneio ficou laranja, maior e com mais volume, pra chamar a atenção de quem ainda não votou.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.46-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📅 Combinar jogos:</b> em torneios sem horário fixo por jogo, os jogadores de cada confronto agora combinam quando jogar pelo próprio app. Cada um propõe uma data e hora (ou dias da semana) e marca o que consegue; quando todos dão o OK ✅ no mesmo horário, o jogo fica combinado e a data aparece direto no card do confronto.</li>' +
        '<li><b>🛠️ Organizador acompanha:</b> botão "📅 Combinar jogos" mostra o andamento de cada jogo da rodada (combinado / combinando / sem propostas) e avisa os jogadores num toque.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.1.45-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(26 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.85-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📱 Convidar agora cria a amizade de verdade:</b> quando alguém entra no app pelo seu QR Code ou link de convite (botão Convidar), vocês viram amigos automaticamente — antes isso só funcionava no convite de torneio.</li>' +
        '<li><b>🖨️ Convite para imprimir mais caprichado:</b> o convite do app ganhou os mesmos ajustes de tamanho do convite de torneio — dá pra regular logo, QR Code e textos com pré-visualização na hora, além de escolher papel (A4/A5/A6/Carta), cor e orientação. Personalize o impresso do jeito que quiser.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.82-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Nome único entre contas:</b> duas pessoas diferentes não podem usar exatamente o mesmo nome no app. Ao editar o perfil, se o nome já é de outra conta, o app pede uma variante (ex.: incluir o sobrenome ou uma inicial). E agora, no primeiro acesso, se o nome vindo do Google/Apple já existir, o app já adota uma variante automaticamente — sem travar a sua entrada. Nomes de jogadores avulsos (sem conta) podem se repetir normalmente.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.81-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Troféus e W.O. da Liga reconhecem cada jogador da dupla:</b> seus troféus e estatísticas (torneios disputados, vitórias, pódios) agora contam também os torneios em que você foi o segundo jogador da dupla — antes só o capitão recebia o crédito. E nos grupos da Liga, qualquer jogador do grupo (inclusive o parceiro de dupla) pode declarar falta e chamar substituto. Tudo identificado pela sua conta (uid).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.80-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Movimento nos locais conta cada jogador da dupla:</b> no gráfico de movimento e nas listas "agora no local" / "próximas horas", um torneio do dia passou a contar cada pessoa da dupla — antes só o capitão aparecia e o parceiro sumia. Se o seu amigo é o segundo jogador da dupla, ele agora aparece com nome e foto. Tudo identificado pela conta (uid).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.79-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.77-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 "Seu jogo" e lançar placar funcionam pra cada jogador da dupla:</b> na chave, o seu jogo agora fica destacado e o botão de lançar placar aparece mesmo quando você é o segundo jogador da dupla (e o nome exibido é só o do seu parceiro). O reconhecimento é pela sua conta (uid) — vale também no filtro "Só meus jogos", no destaque do seu grupo e na detecção de quem ficou de fora da rodada.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.76-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Sair da inscrição, da lista de espera e ativar/desativar para o sorteio funcionam pra dupla:</b> quem entrou em dupla agora consegue se desinscrever, sair da lista de espera e ligar/desligar a própria participação no próximo sorteio — antes o segundo jogador da dupla ficava preso. Tudo reconhecido pela sua conta (uid). Dois jogadores de mesmo nome também não colidem mais na lista de espera.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.75-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Aviso de categoria chega a quem entrou só com celular:</b> quando o organizador define ou ajusta a sua categoria, o aviso agora é endereçado pela sua conta (uid) — antes dependia do e-mail, então quem se cadastrou só com celular nunca recebia. Dois jogadores de mesmo nome também não se confundem mais. Avisos antigos continuam funcionando.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.74-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🆔 Presença, ausência, VIP e enquete reconhecem cada um pela conta:</b> check-in, W.O., estrela de VIP e voto em enquete agora identificam a pessoa pela conta dela (uid) em vez do nome. Dois jogadores com o mesmo nome não se confundem mais, e cada membro de uma dupla é tratado individualmente. Dados antigos continuam funcionando normalmente.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.73-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🗳️ Voto em enquete funciona pra dupla:</b> quem entrou em dupla agora consegue votar nas enquetes de definição do torneio — antes, o segundo jogador da dupla era barrado. Os dois são reconhecidos pela conta (uid).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.72-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>👑 Coroa do Rei/Rainha também na Partida Casual:</b> quem vence a série de 3 jogos do Rei/Rainha (jogando com todos os parceiros) ganha a coroa — agora tanto no torneio quanto na partida casual. Coroa de Rainha para mulheres, de Rei para homens.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.71-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.69-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🗑️ Excluir conta apaga todos os seus torneios:</b> ao excluir a conta, agora todos os torneios que você organizou são removidos pela sua conta (uid) — antes, torneios de quem entrou só com celular podiam ficar para trás.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.68-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.66-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📧 Confirmação por código no Hotmail/Outlook/UOL:</b> nesses provedores que costumam bloquear nosso e-mail, agora enviamos um e-mail de <b>texto simples com um código de 6 dígitos</b> (sem link) — chega muito melhor. É só digitar o código no app. O caminho pelo <b>celular</b> (SMS + WhatsApp) continua como alternativa.</li>' +
        '<li><b>✅ Aviso por WhatsApp:</b> quem confirma a conta pelo celular recebe um WhatsApp avisando que pode entrar com <b>celular + senha</b> daqui pra frente.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.65-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📱 Confirmação por celular em destaque:</b> quando o e-mail de confirmação não chega (comum em Hotmail/Outlook/UOL), a tela de confirmação agora oferece, com calma e clareza, confirmar pelo <b>celular</b> — código por SMS + botão de autenticar no WhatsApp, sem depender do e-mail.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.64-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📋 Presença e lista de espera contam a dupla certo:</b> ao marcar presença/ausência e na lista de espera, os dois jogadores da dupla são considerados mesmo quando o nome exibido é só o de um deles.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.63-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🤝 Lista de parceiros sem duplicar:</b> quem já está em dupla não aparece mais como "disponível para parear".</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v3.0.61-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(24 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>⏰ Plano de ida com status:</b> quem <b>se atrasou</b> (passou da hora de chegar e ainda não fez check-in) aparece com um <b>relógio âmbar</b>; quem <b>chegou antes</b> mostra "chegou antes"; e quem <b>passou da hora de sair</b> e continua no local segue aparecendo ("alongado"). Quem já fez check-in não duplica como plano.</li>' +
        '<li><b>📍 Amigo no local volta a aparecer com nome:</b> um plano <b>em andamento</b> (já começou, não acabou) volta a mostrar o nome do amigo — antes sumia da lista mesmo estando no horário.</li>' +
        '<li><b>🪪 Trocar de nome não quebra mais nada:</b> quando alguém muda o nome, a mudança <b>propaga pra tudo</b> (duplas, lista de espera, convites de dupla, chaves, classificação, presenças) — sempre <b>pelo seu cadastro (uid)</b>, não pelo nome. Corrige duplas que "reverteram" após renomear.</li>' +
        ...
        '<li><b>👥 Convite de dupla mais legível:</b> o card de <b>dupla pendente</b> mostra os <b>números de inscrição</b> de cada um, e nomes longos <b>encolhem e quebram em 2 linhas</b> em vez de cortar.</li>' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>📊 Gráfico do dia certo:</b> a tabela hora-a-hora do local mostra o movimento do dia da sua <b>ida mais próxima</b> (não sempre hoje).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.74-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(22 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🗓️ Planejar ida com a movimentação do local:</b> ao planejar, aparece a <b>tabela hora-a-hora</b> (você + amigos) cobrindo a <b>hora atual e o horário de funcionamento</b> do local, com <b>rolagem lateral</b> — ajuda a escolher a melhor hora. Atualiza ao trocar Hoje/Amanhã.</li>' +
        '<li><b>📍 Locais mais limpos:</b> um torneio só aparece no <b>movimento</b> e como <b>plano ativo</b> dos seus locais <b>a partir de 2 dias antes</b> — antes um torneio distante poluía o gráfico e o card.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.72-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(22 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🗓️ Planejar ida mais inteligente:</b> agora aparecem <b>todas as suas modalidades preferidas</b> pra escolher. O app <b>lembra quais você ativou/desativou</b> e os <b>horários</b> que usou da última vez <b>em cada local</b>, e já abre assim na próxima.</li>' +
        '<li><b>📍 "Próximas horas" dos seus locais:</b> um torneio só passa a aparecer ali <b>a partir de 2 dias antes</b> do evento — antes um torneio distante poluía a lista.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.70-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(22 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.66-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(22 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>👫 Cards de dupla — gênero/categoria dos dois.</b> Agora o gênero e a categoria aparecem para <b>ambos</b> os jogadores da dupla (antes faltava no 2º). E a <b>foto fica sempre junto do nome</b>, sem quebrar linha à toa.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.65-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(22 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🔎 Barra de filtro/busca alinhada.</b> Sem o espaço sobrando entre o menu aberto e a barra; o filtro de modalidade e a busca agora têm a mesma altura.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.51-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(21 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.8.47-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(21 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.7.86-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(20 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🖐️ Arrastar ficou bem mais fácil.</b> Quando você começa a arrastar um card de inscrito (pra formar dupla, mesclar ou promover a co-organizador), os <b>outros cards encolhem e mostram só o nome</b>, em 2-3 colunas — assim o caminho até soltar fica curtinho. Soltou, tudo volta ao tamanho normal.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.7.85-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(20 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.7.83-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(20 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.31-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(16 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🧹 Código antigo de playoff de Liga removido.</b> Confirmado que nenhum torneio usava a antiga fase final de playoff — o módulo foi removido por completo. A fase final da Liga vive agora no construtor de fases. Limpeza interna, sem impacto pra você.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.30-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(16 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>⚙️ Caixa de configuração do torneio não estoura mais lateralmente.</b> No card do torneio, a caixa "⚙️ … configuração ▾" podia ultrapassar a borda e cortar o texto "configuração" à direita — agora ela se ajusta à largura do card (o texto longo do meio vira reticências e a etiqueta do fim fica sempre legível).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.29-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(16 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🏆 Fase final da Liga agora é uma fase do construtor de fases.</b> O botão "Configurar Playoffs (Fase Final)" e o interruptor de fase final na criação foram removidos da Liga. A partir de agora a fase final é montada como uma nova fase adicionada em sequência ao torneio Liga, quando o organizador quiser. Ligas que já tinham playoff gerado continuam funcionando normalmente.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.28-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📷 Foto do local volta a aparecer no tema claro.</b> No tema claro, uma regra de estilo cobria a foto do local (Google) com um fundo claro — corrigido: cards com foto mantêm a imagem e o texto branco.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.27-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🎨 Temas simplificados: Noturno e Claro.</b> Os temas Pôr do Sol e Oceano saíram — agora são só <b>2 temas</b>, com contraste consistente (caixas escuras + texto claro no tema claro, e o inverso no escuro).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.26-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>👁️ Caixas de inscritos/configuração mais visíveis.</b> As caixas agora <b>contrastam com o fundo do card</b>: no tema escuro ficam claras (texto escuro) e no tema claro ficam escuras (texto claro) — antes quase sumiam.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.25-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🌍 Formato Copa do Mundo.</b> Agora dá pra fazer <b>Fase de Grupos → Eliminatória que você configura</b>: crie um torneio de Grupos e adicione uma fase de Eliminatória — ao terminar os grupos, o botão "Avançar" monta a chave puxando os classificados de cada grupo (no formato e pareamento que você definiu).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.24-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🗓️ Data e hora perfeitamente alinhadas.</b> A data ficou em duas linhas (início em cima, fim embaixo), com <b>data e hora em colunas próprias e alinhadas</b> entre as linhas.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.22-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🎨 Tarjas escuras com texto claro (tema claro).</b> Datas, inscritos, configuração e contagens regressivas sobre as tarjas escuras agora ficam <b>com texto claro</b> pra dar leitura e contraste. Cor (verde/vermelho) só direto no fundo claro.</li>' +
        '<li><b>🟢🔴 Ativado/Desativado mais claro.</b> O botão virou uma <b>pílula verde (Ativado) / vermelha (Desativado)</b> com texto branco — igual nos dois temas.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.20-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>⚙️ O motor já respeita suas escolhas de fase.</b> Ao avançar pra próxima fase, as duplas agora se formam pela estratégia escolhida (1º+2º/3º+4º ou 1º+4º/2º+3º), e as chaves aparecem com o <b>nome que você deu às trilhas</b> (Ouro/Prata ou o que você quiser).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.19-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🤝 Como montar as duplas você escolhe.</b> Quando uma fase forma duplas fixas com os classificados da fase anterior, o organizador decide o pareamento: <b>1º+2º · 3º+4º</b> (mais fortes juntos) ou <b>1º+4º · 2º+3º</b> (equilibrado).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.18-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🔀 Ordenar inscritos por chegada funciona.</b> O botão de ordem cronológica (🕐 ↑/↓) não invertia a lista — corrigido.</li>' +
        '<li><b>🏷️ Trilhas com nome próprio.</b> No construtor de fases, as chaves de destino (Ouro/Prata) viraram <b>campos editáveis</b> — o organizador dá o nome que quiser.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.17-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🖥️ Conteúdo centralizado em telas largas.</b> No desktop/monitor grande o conteúdo ficava grudado à esquerda com um vão à direita. Agora a barra do topo ocupa a largura toda e o <b>conteúdo fica centralizado</b>.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.16-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>⏳ Tela de carregamento mais suave.</b> A barra de progresso não recua mais (ela ficava "avançando e voltando" quando o app atualizava). Agora a atualização recarrega <b>uma única vez</b>, e nunca na primeira instalação.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.15-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🔑 "Esqueci minha senha" agora envia de forma confiável.</b> Se o envio principal falhar por instabilidade, o app cai num <b>envio direto pelo Firebase</b> (o mesmo servidor do login) — o link sai do mesmo jeito. E nunca mais diz "conta não existe" por engano: isso só aparece quando o servidor confirma de fato.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.13-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🇬 Botão "Entrar com Google" em destaque.</b> Quando o app reconhece que sua conta é Google, o botão fica <b>verde com brilho</b> naquele momento — fácil de achar. Depois volta ao normal.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.12-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🔑 Redefinir senha pelo link voltou a funcionar.</b> O link de redefinição (e o de entrar por celular pelo WhatsApp) mostrava <b>"Erro ao carregar"</b> ao ser aberto — uma corrida na inicialização fazia a página falhar antes de validar o link. Corrigido: agora o link espera o app carregar por completo antes de validar.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.11-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🇬 Conta do Google reconhecida no login.</b> Se você criou a conta com o <b>Google</b> e tenta entrar com a senha do Google (que não vive aqui) — ou clica em "Esqueci minha senha" com um e-mail do Gmail — o app agora <b>aponta e destaca o botão "Entrar com Google"</b> que já está na tela (com brilho), em vez de mandar criar conta ou redefinir uma senha que não existe.</li>' +
        ...
        '<li><b>🔑 "Esqueci minha senha" em destaque.</b> Virou um <b>botão azul</b> bem visível na tela de entrar.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.2-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🔒 Trocar senha no perfil.</b> Agora dá pra <b>definir ou trocar sua senha</b> direto no perfil — sem precisar do link de redefinição.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.1-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📱 Entrada por celular corrigida.</b> Quem <b>criou a conta pelo número</b> e depois <b>adicionou um e-mail</b> voltava a receber "senha errada" mesmo com a senha certa. Corrigido — o login por celular agora encontra sua conta pelo número, independente do e-mail.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.6.0-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(15 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>✉️ E-mails em português.</b> Mensagens de confirmação e de redefinição de senha passam a chegar sempre em português.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.5.0-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(14 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📱 Entrada por celular mais confiável.</b> Corrigido o erro que travava o <b>SMS</b> (uma verificação de segurança que ficava presa e impedia o envio — e que às vezes deixava o botão "Entrar" sem reagir). O código por SMS volta a funcionar, e o <b>link pelo WhatsApp</b> continua como alternativa que não depende dessa verificação.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.4.98-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(14 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>📱 Criar conta e entrar só com o celular (sem e-mail).</b> Pra quem usa UOL, Hotmail e similares (que filtram e-mail), agora dá pra <b>cadastrar e entrar usando só o número do celular</b>: digite o número e receba um <b>código por SMS</b> e um <b>link pelo WhatsApp</b>. Confirmou? Já está dentro — sem precisar de e-mail.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.4.97-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(14 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.4.95-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(14 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>✨ Tela de abertura mais limpa.</b> Barra de progresso visível durante o carregamento e brilho piscante removido da bolinha.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
    ...
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.4.93-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(14 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>⏳ Tempo de abertura fixo e limitado.</b> ~3,5s, nunca mais que ~4,5s.</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
      '<div style="font-weight:800; font-size:1rem; margin-bottom:8px;">🏷️ v2.4.92-beta <span style="color:var(--text-muted); font-weight:400; font-size:0.78rem;">(14 de Junho, 2026)</span></div>' +
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🐞 Detecção de sessão à prova de iOS.</b> A abertura passou a usar o sinal autoritativo do Firebase pra saber que você está logado (o iPhone às vezes limpa o cache local mantendo o login).</li>' +
      '</ul>' +
    '</div>' +
    '<div style="margin-bottom:1rem;border:1px solid var(--border-color,rgba(255,255,255,0.08));border-radius:12px;padding:14px 16px;">' +
