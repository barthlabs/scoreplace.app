// 2.3.92 — nada que o organizador define entra mais no seu cadastro: categoria e gênero que ele atribui valem DENTRO do torneio, inclusive para cada pessoa de uma dupla, e a busca do letzplay também para de escrever no perfil de quem foi buscado. O seu perfil só muda pelo que você declara. O selo de "categoria apurada" e o registro de quem mexeu no seu cadastro passam a ser do servidor, a busca de um atleta só começa pelo @ que ele mesmo declarou, a coroa de Rei/Rainha respeita o gênero que o organizador definiu, cópias antigas de gênero guardadas na inscrição deixam de vencer o seu perfil, a decisão sobrevive a formar e desfazer dupla, aparece igual no distintivo de cada pessoa da dupla, vale também na contagem de categorias e na escolha de suplente da Liga, e a consulta a um atleta continua exigindo o @ que ele mesmo declarou.
...
// 2.3.10 — erros de leitura deixam de virar respostas erradas: pedir o código de verificação não diz mais "conta sem e-mail" para quem tem, retomar uma exclusão não diz que a conta já foi apagada quando ela está viva, e um troféu com regra quebrada aparece no registro em vez de deixar de ser concedido em silêncio.
// 2.3.9 — unir duas contas suas passou a ter volta: 30 dias para separar de novo, com um e-mail avisando o que foi feito e trazendo o caminho de volta. E o celular que o organizador registra volta a levantar a pergunta de segunda conta quando o nome e o sobrenome batem.
// 2.3.8 — quem tem duas contas passa a ser avisado com clareza (diz em qual torneio está a outra) e resolve com um toque: o "sim, unir" manda a confirmação sozinho. O celular registrado pelo organizador volta a ser só contato: o mesmo número em duas contas, como casal ou mãe e filho, deixa de travar o organizador. E o site deixa de servir arquivos internos que não são do site — junto com eles saiu do ar um e-mail de uma pessoa que tinha escapado para dentro de um arquivo de teste.
// 2.3.7 — ver troféu, ranking, foto e ficha de alguém deixa de baixar a ficha da pessoa. Placar dos sets do mesmo tamanho nas duas seções da tela inicial, com mais folga. O sorteio não acontece mais com o elenco pela metade.
...
window._RELEASE_NOTES_HTML = (function () {
  var html =
    ...
    // receberam cache-buster correspondente, para que a correção chegue a todos.
    ...
    // eliminatória; o organizador escolhe manter no torneio ou excluir definitivamente.
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🎾 Melhor de 3 sem campo enganoso:</b> Set 1 e Set 2 aparecem juntos para o resultado inteiro ser lançado de uma vez; o Super Tie-Break só aparece quando há 1×1. Ao terminar, o card mostra somente o placar por sets. Valores claramente impossíveis, como 66–42 em um set, recebem aviso antes de serem gravados.</li>' +
        '<li><b>🎾 Cards de jogo com a mesma geometria:</b> Novidades, Próximo Jogo, Últimos Resultados e chave usam a mesma régua. Nome curto ocupa uma linha e não reserva uma linha vazia; nome longo usa duas linhas com fonte menor quando precisa. O vão entre integrantes continua o mesmo.</li>' +
        ...
        '<li><b>📋 Listas mais diretas:</b> a espera mostra os cards na própria ordem, sem repetir “primeiro da fila”, “segundo da fila” ou instrução de check-in. Espera, inativos e W.O. passam a ocupar duas colunas quando a tela comporta, mantendo uma coluna no celular.</li>' +
        '<li><b>📊 Cada nome leva à ficha certa:</b> na classificação, nos jogos, na espera, nos inativos e nos inscritos, tocar ou navegar pelo teclado no nome de uma pessoa identificada abre a ficha e as estatísticas dela. O balão ao lado abre WhatsApp quando há telefone e e-mail quando não há.</li>' +
        '<li><b>🔄 Torneio aberto sempre mostra o estado confirmado:</b> lista de espera, inativos, W.O., duplas, jogos, grupos e resultados passam a aguardar a confirmação do servidor. Uma cópia antiga do aparelho não é mais exibida como informação atual.</li>' +
        ...
        '<li><b>🧭 Cada fase diz o que ela é, em vez de o torneio adivinhar:</b> o app decidia se uma fase era de grupos, de pontos corridos ou eliminatória lendo o <b>texto do formato</b> escrito no topo do torneio — a mesma pergunta respondida em vários lugares, cada um com a sua lista de nomes. Agora a própria fase declara o que é, e a chave, a preparação do sorteio, a prévia da eliminatória e a conferência de número ímpar passaram a perguntar a ela. <b>Torneio criado antes disso continua sendo lido pelo texto antigo</b>, que segue valendo como queda: nenhum torneio foi convertido e nada some. Na tela, nada muda — o que muda é haver uma resposta só.</li>' +
        ...
        '<li><b>🔒 Ninguém puxa o próprio nível do letzplay:</b> a busca do letzplay serve para o organizador conferir o perfil público de <b>quem está inscrito</b> — e era possível alguém registrar a própria leitura e, com isso, definir a própria categoria. Agora isso é recusado, e apagar a leitura de outra pessoa também. Quem quer atualizar a própria categoria puxa o histórico <b>pelo próprio perfil</b>, como sempre.</li>' +
        '<li><b>👥 O organizador passa a ver quando duas inscrições são a mesma pessoa:</b> o aplicativo já detectava conta duplicada e já perguntava à própria pessoa no cadastro — mas quem tem as duas inscrições lado a lado, o organizador, nunca era avisado. Era por isso que a junção das contas falhava. Agora a <b>Análise de inscritos</b> mostra os pares que parecem a mesma pessoa, com o contato <b>parcialmente escondido</b> o bastante para reconhecer — e <b>só quando as duas pessoas permitem divulgar aquele dado</b> no perfil. Número que a organização digitou, e ninguém confirmou, não vira pista. É só informação: o aplicativo continua <b>não unindo conta sozinho</b>.</li>' +
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🎾 O placar de melhor de 3 não vira mais um set só:</b> confirmar de novo um jogo já encerrado deixou de reescrever a partida com o último placar — a tela avisa que o jogo terminou e manda corrigir pela edição, que preserva os sets. E, depois de confirmar, o card volta a mostrar o placar recém-gravado em vez do anterior: era essa tela desatualizada que levava a lançar duas vezes.</li>' +
        '<li><b>🟢 Cada set com a sua cor:</b> quem venceu um set aparece em verde naquele set, mesmo tendo perdido a partida — na tela inicial, na chave e no e-mail de novidades. O set que ainda não foi jogado mostra um travessão no lugar do zero, que parecia um placar 0.</li>' +
        '<li><b>📬 E-mail de novidades mais limpo:</b> o placar aparece uma vez só, na tabela colorida, com o subponto do tie-break e cores legíveis no tema claro e no escuro. Avisos de placar chegam como <b>fundamental</b> para quem jogou aquele jogo e como <b>importante</b> para quem só acompanha.</li>' +
        '<li><b>🔎 Uma busca só na chave, e o botão que leva ao jogo certo:</b> a barra de busca duplicada saiu, e o “Ir para o torneio” das novidades passa a abrir exatamente no jogo do card — inclusive na fase eliminatória, onde não há grupo. Os cards de inativos e de W.O. voltam a mostrar o número de inscrição de cada pessoa.</li>' +
        '<li><b>✅ Criação confirmada, imagens salvas e recuperação de resultados:</b> criar ou copiar um torneio só mostra sucesso depois da confirmação. Se a conexão falhar, tentar novamente recupera o mesmo pedido. A edição volta a enviar novas imagens e preserva o torneio escolhido.</li>' +
        ...
        '<li><b>🔒 Ajustes da chave preservam atualizações de outros aparelhos:</b> corrigir rodadas antigas da chave, definir uma quadra, publicar um sorteio em revisão ou aplicar uma substituição por W.O. agora só grava a mudança no registro mais recente. Se um placar chegou enquanto a tela estava aberta, ele continua intacto. Uma versão sem o mecanismo seguro avisa para atualizar em vez de arriscar sobrescrever o torneio.</li>' +
        '<li><b>🎲 Rodadas novas não se repetem em caso de conexão instável:</b> gerar uma rodada extra ou fechar uma rodada de Liga agora identifica a rodada que deve nascer e mantém o mesmo sorteio se a gravação precisar ser repetida. Se outro aparelho já criou aquela rodada, o app para e pede para atualizar em vez de criar confrontos duplicados.</li>' +
        '<li><b>🏅 Resultado aprovado aparece onde você acompanha:</b> em torneio grande, o placar já confirmado podia ficar no registro do jogo, mas a chave e <b>“Novidades no seu torneio”</b> continuavam mostrando 0–0 a partir de uma cópia antiga. Agora as duas telas leem o espelho de resultado e se atualizam quando ele chega. O aplicativo também força a troca de versão quando há uma atualização, para não misturar tela antiga com dados novos; a publicação só avança depois de uma suíte aprovada para essa mesma versão.</li>' +
        '<li><b>✅ Confirmar não aparece mais como lançar:</b> quando o organizador confirma um placar pendente, o aviso agora diz quem <b>confirmou</b> e quem realmente <b>lançou</b> o resultado. A comunicação usa o nome de exibição do perfil — nunca o e-mail — e conserva a autoria mesmo depois de a proposta ser convertida em resultado final.</li>' +
        '<li><b>⏱️ Cada fase controla as próprias rodadas:</b> uma classificatória de rodada única não mostra régua. Ao avançar para a eliminatória, o app registra aquele instante como início da nova fase e exibe ali — somente se houver duas ou mais rodadas — a divisão das rodadas eliminatórias. A sequência conserva a numeração do torneio (<b>R2, R3, oitavas, quartas, semifinais e final</b>), cada prazo mostra a data, a hora editável e a duração, inclusive quando a tela é estreita. Os ajustes ficam na eliminatória e nunca voltam para a classificatória.</li>' +
        '<li><b>🔎 Histórico de quem saiu da fase permanece encontrável:</b> buscar alguém na chave inclui participantes ativos, espera, inativos e W.O. Essas listas usam o mesmo card de participante do torneio e, para W.O., mostram também o grupo de origem — assim o histórico da classificatória não desaparece ao avançar de fase.</li>' +
        '<li><b>🔄 Atualização obrigatória para esta correção:</b> os aparelhos recebem uma nova versão do aplicativo e renovam os arquivos da tela. Assim, a divisão corrigida das rodadas não fica escondida atrás de uma cópia antiga do navegador. A publicação confere a versão já servida e a sequência de commits, bloqueando qualquer reutilização.</li>' +
        '<li><b>🔒 Placar só é confirmado pelo servidor:</b> lançar, aprovar ou contestar resultado envia apenas a intenção autenticada; a confirmação, a trilha de auditoria e o aviso voltam do servidor como uma única resposta. Isso impede que uma tela antiga mostre autoria ou placar diferente do registro oficial.</li>' +
        '<li><b>🔒 Ajustes administrativos chegam pelo servidor:</b> avançar fase, publicar ou cancelar sorteio em revisão, reabrir torneio, alterar formato padrão e fechar inscrições pelo prazo são confirmados no registro mais recente pelo servidor. Isso evita que uma aba antiga regrave resultados, rodadas ou inscrições que chegaram de outro aparelho.</li>' +
        '<li><b>✏️ Placar da fase anterior pode ser corrigido:</b> ao avançar uma fase, um jogo que ficou com set errado ou incompleto perdia os campos de correção. Agora quem pode lançar resultado continua podendo corrigir também nessa fase: o organizador e o árbitro registram a decisão, e a edição de participante continua como proposta para o outro time confirmar ou contestar. Em melhor de 3 ou 5, <b>“Editar”</b> abre todos os sets já lançados, inclusive o tie-break, preenchidos para que seja corrigido apenas o campo errado — sem apagar os demais. Uma gravação atrasada de set também não pode mais apagar uma proposta de resultado completa nem o super tie-break.</li>' +
        '<li><b>✏️ Editar continua no próprio jogo:</b> ao tocar em <b>“Editar”</b>, o card não abre mais uma tela paralela. Os números que já estão no card viram campos ali mesmo, na mesma ordem de Sets e STB; <b>Salvar</b> e <b>Cancelar</b> ficam no cabeçalho daquele jogo.</li>' +
        '<li><b>✕ Cancelar segue o padrão visual:</b> durante a edição de placar, <b>Cancelar</b> usa o botão vermelho com texto branco e a ação de W.O. fica temporariamente oculta, deixando o card claro e legível.</li>' +
        '<li><b>🎾 Edição de sets acompanha o placar:</b> os números continuam verdes para vitória e vermelhos para derrota enquanto você corrige. O campo de tie-break só aparece no set que realmente precisa dele; seus pontos ficam menores e com espaço próprio. Antes do primeiro set, jogos melhor de 3 ou 5 usam a mesma escala compacta de um jogo de 1 set.</li>' +
        '<li><b>📍 Definir a quadra não desfaz o jogo:</b> escolher ou remover a quadra agora atualiza somente aquele confronto. Se outro aparelho acabou de lançar placar, W.O. ou uma mudança na chave, essa informação continua preservada.</li>' +
        '<li><b>🔔 Avisos reconhecem o vencedor certo:</b> os placares das notificações seguem a mesma identidade da chave, inclusive depois de uma troca de dupla. O tie-break continua menor e separado do set seguinte para leitura rápida.</li>' +
        '<li><b>🔒 Publicar a chave preserva novidades:</b> se um placar ou outra atualização chegar enquanto o organizador revisa um sorteio, a publicação mantém essa novidade no torneio.</li>' +
        '<li><b>↩️ Reverter W.O. preserva a chave atual:</b> ao reabrir uma partida decidida por ausência, o app mantém placares e atualizações que tenham chegado de outro aparelho.</li>' +
        '<li><b>🔒 Ajustes do organizador preservam novidades:</b> cancelar um sorteio em revisão ou ajustar a categoria de um participante não apaga placares e atualizações recebidos enquanto a tela estava aberta.</li>' +
        '<li><b>🗳️ Decisões de sorteio não voltam dados antigos:</b> criar ou resolver uma enquete, fechar inscrições para os grupos, reabrir vagas e decidir quem avança agora trabalham sobre o torneio mais recente. Placar, presença e inscrições lançados por outro aparelho enquanto a decisão estava aberta continuam preservados.</li>' +
        '<li><b>🔒 Avançar a eliminatória também preserva o que chegou:</b> ao montar a chave depois da fase de grupos, o organizador não regrava mais uma cópia antiga do torneio. Placar, novidade e ajustes feitos em outro aparelho continuam no lugar; se a fase já tiver sido avançada, o app avisa em vez de substituir a chave.</li>' +
        '<li><b>✎ Corrigir resultado preserva novidades:</b> ao reabrir um placar para corrigir, o app mantém as atualizações de chave e resultados que tenham chegado de outro aparelho.</li>' +
        '<li><b>📬 Resultado fácil de conferir:</b> avisos de placar por sets agora trazem uma tabela alinhada com <b>Set 1, Set 2, STB</b> e os números de cada dupla na mesma coluna. O time vencedor fica em verde e o outro em vermelho. A mesma estrutura chega nas notificações do aplicativo e nos e-mails, tanto quando o placar é proposto quanto quando é confirmado, sem depender de interpretar uma sequência como “6 5 14”.</li>' +
        '<li><b>📣 Novidades acompanha a largura real:</b> a prévia fechada mede de novo a grade logo depois de ela entrar na tela. Assim, quando cabem três cards, aparecem três — como em <b>Seus últimos resultados</b> e <b>Próximos jogos</b> — em vez de ficar presa no cálculo provisório de uma coluna.</li>' +
        '<li><b>🕒 Novidades agora respeita a ordem em que os placares chegam:</b> cada resultado novo entra no topo e empurra os anteriores para baixo, inclusive quando jogos de uma mesma rodada aparecem intercalados com outros. A data do resultado é entendida tanto nos registros antigos quanto nos carimbos atuais do Firebase, e a prévia continua usando toda a largura disponível.</li>' +
        '<li><b>📣 Placar parcial também vira novidade:</b> se os sets já foram lançados e falta somente o super tie-break ou a confirmação final, o jogo aparece no topo de <b>“Novidades no seu torneio”</b> pela hora em que foi atualizado. Ele continua marcado como jogo em andamento; não é tratado como resultado final.</li>' +
        '<li><b>📱 O card do jogo parou de ser cortado no celular:</b> na tela estreita, o card era desenhado com uma largura maior do que a que realmente sobrava — a conta usava a largura da <b>janela</b>, que inclui a barra de rolagem e ignora o trilho lateral "Fase anterior", a margem do container e o próprio rolador horizontal da chave. Sobrava tudo o que estava no <b>fim</b> da linha: o <b>"Ao Vivo"</b>, o botão de editar o link do grupo e a <b>caixa do placar</b>. Por isso o placar parecia "de tamanho errado" — ele estava <b>fora da tela</b>, não menor. Agora a largura é <b>medida</b> no espaço real e acompanha o giro do aparelho.</li>' +
        '<li><b>👆 "Ver mais / ver menos" parou de abrir o torneio sem querer:</b> tocar na linha para expandir ou recolher uma seção (previsão do tempo, torneio completo) às vezes <b>abria o torneio</b> junto. O bloqueio existia, mas só no <b>clique</b> — e num celular o card reage ao <b>toque</b>, que acontece antes: quando o clique chegava para ser barrado, o torneio já tinha aberto. Agora o gatilho segura o gesto inteiro, do encostar ao soltar, e a <b>área de toque ficou maior</b> — errar o alvo por alguns pixels também levava para dentro do torneio.</li>' +
        '<li><b>🎯 Ligar o "Só meus jogos" agora leva você até o seu jogo:</b> ao ativar o filtro, a chave <b>rola até a sua partida</b> e o <b>vão em branco</b> que sobrava embaixo (herdado da lista cheia) desaparece. Ao <b>desligar</b>, todos os jogos voltam aos seus lugares — acima e abaixo — mas a tela <b>não sai do seu jogo</b>: ele fica parado exatamente onde estava, sem pulo. Se você estiver com um placar em edição, nada rola.</li>' +
        '<li><b>📅 O botão "Veja data proposta" ficou mais estreito:</b> o texto passou a ser escrito em <b>duas linhas</b>, como o "Aplicar W.O." e o "Seu grupo de whats de jogo" já eram — assim ele ocupa menos largura na fileira de botões do card.</li>' +
        '<li><b>🔎 O "Só meus jogos" da chave parava de explicar o que fez:</b> ao ligar o toggle num torneio em que você não tem jogo — o que é comum quando o organizador inscreveu todo mundo à mão, sem conta —, a chave <b>esvaziava</b> e a tela dizia apenas <b>"Nenhum jogo encontrado."</b>, que é a frase da <b>busca</b>. O filtro estava certo, mas parecia que o app tinha quebrado. Agora a tela diz o que aconteceu: <b>"Você não tem jogos nesta chave. Desligue \'Só meus jogos\' para ver todos."</b> — e, se houver também um nome digitado na busca, ela avisa que a limitação é a soma dos dois. <b>Nenhum jogo passou a aparecer ou a sumir por causa disso</b>; o que mudou é a tela dizer por que está vazia.</li>' +
        '<li><b>🪪 "É o meu jogo?" passou a ter uma resposta só:</b> a chave usava <b>dois critérios diferentes</b> para a mesma pergunta — um para <b>desenhar</b> o card com o seu destaque, outro, mais restrito, para <b>filtrar</b>. O mesmo jogo podia ser seu para aparecer em destaque e "não seu" para o filtro. Agora a pergunta é respondida em um lugar só, pela mesma identidade por <b>uid</b> que a classificação, o W.O. e o avanço de fase já usam — inclusive recuperando o dono do lugar quando o sorteio gravou o jogo sem essa marca. <b>Continua sendo só por conta:</b> nada de casar por nome parecido.</li>' +
        '<li><b>⌚ O batimento no Apple Watch voltava a ficar atrasado no meio da partida:</b> quem joga com o relógio percebia o número <b>mais baixo do que a sensação</b> — e depois de um tempo de partida, não desde o começo. A causa: o relógio ligava e desligava a <b>sessão de treino</b> conforme o celular avisava que a partida estava no ar, e um aviso passageiro (o app do celular sendo retomado, a tela do placar se redesenhando) derrubava essa sessão. Ao tentar recomeçar, uma nova sessão nascia por cima da anterior que ainda estava encerrando, o relógio recusava em silêncio, e a leitura caía numa fonte <b>mais lenta</b>: em vez do batimento do instante, o de segundos atrás — no tênis, quase sempre o <b>vale</b> entre dois pontos, nunca o pico. Agora um aviso passageiro <b>não derruba mais o treino</b> (há uma carência antes de encerrar), duas sessões não se atropelam, e a falha deixou de ser silenciosa. <b>Isso também protege os anéis de atividade</b>, que antes podiam perder o treino por causa desse piscar. ⏳ <b>Chega no relógio com a próxima atualização da App Store</b> — o app do pulso só muda quando a loja publica uma versão nova.</li>' +
        '<li><b>⌚ A Ajuda passou a dizer quais relógios funcionam:</b> a <b>Central de Ajuda</b> ganhou uma seção de <b>relógio</b>. Ela responde a pergunta como ela é feita — <b>“o meu serve?”</b> — sem lista de aparelhos que envelhece: vale a partir do <b>watchOS 7</b> (na prática, Apple Watch <b>Series 3 ou mais novo</b>, com iPhone no <b>iOS 15</b> ou mais novo) e a partir do <b>Wear OS 3</b> (Galaxy Watch4 ou mais novo, Pixel Watch de qualquer geração, TicWatch Pro 3/5, Fossil Gen 6). Diz também o que <b>não</b> serve — Wear OS 2 ou anterior e pulseiras sem Wear OS — e lembra que o app de relógio vem com a versão instalada da <b>loja</b>, não com o atalho do navegador.</li>' +
        '<li><b>🥈 A etiqueta PROMO acompanha a dupla até o fim da chave:</b> a dupla promovida da linha de baixo (a melhor da Prata que subiu para a Ouro) só era marcada no <b>primeiro</b> jogo eliminatório; ao vencer, virava anônima. Agora a etiqueta segue com ela em todas as rodadas — e ficou mais visível (índigo). A etiqueta REP continua marcando só a rodada da repescagem.</li>' +
        '<li><b>📅 “Propor datas” passou a gravar de verdade em torneio grande:</b> a proposta aparecia na tela e sumia na próxima abertura — quem propôs não via mais, o adversário nunca via, e o organizador também não. Em torneio grande os jogos ficam guardados à parte, e a proposta era gravada no lugar antigo. Agora ela vai para onde o jogo mora, por uma porta do servidor: quem joga vê e edita a sua, os demais do jogo veem e propõem as deles, e o organizador vê tudo e pode apontar a data — inclusive para os 3 jogos do grupo de uma vez.</li>' +
        '<li><b>🔎 A busca da chave leva você até o resultado:</b> na eliminatória, buscar um nome escondia os outros jogos mas a tela continuava parada onde estava — muitas vezes numa área que tinha acabado de ficar vazia, e parecia que a busca não achava nada. Agora, com resultado, a chave <b>rola até o primeiro jogo encontrado</b>, logo abaixo da barra de busca.</li>' +
        '<li><b>📅 Com horário na mesa, o botão avisa:</b> quando alguém já propôs data para o jogo, o botão do card deixa de dizer “Propor datas” e passa a <b>brilhar</b> com <b>“Veja data proposta”</b> e o número de propostas — para ninguém deixar passar um horário esperando resposta. Cada jogo mostra só as propostas <b>dele</b>.</li>' +
        '<li><b>📅 “Propor datas” voltou a salvar:</b> ao propor um horário, a tela dizia <b>“Não salvou”</b> e desfazia a proposta — mesmo com o servidor tendo registrado. Era um erro interno depois de gravar, não falta de rede. Agora a proposta é registrada e fica na tela. O texto de abertura da janela também ficou mais curto, para caber mais horários no celular.</li>' +
        '<li><b>💬 “Propor datas” e “Criar grupo dos jogos” voltaram a aparecer — e agora aparecem mais cedo:</b> na fase seguinte de um torneio grande, quem <b>joga</b> não via nenhum dos dois botões no card do jogo; só o organizador via. Não era permissão nem aparelho: o app só mostrava esses botões nos jogos da <b>“rodada atual”</b>, e na fase nova ele ainda considerava atual a <b>rodada da fase anterior</b>, já encerrada — resultado: <b>nenhum</b> jogo da fase nova liberava os botões. Agora a regra é outra, e mais simples: <b>assim que as duas duplas de um jogo estão definidas</b>, os botões aparecem para quem joga. Isso também <b>adianta o torneio</b> — um jogo de uma rodada mais à frente cujos dois lados já saíram pode ser <b>combinado e jogado antes</b> de a rodada anterior terminar. Jogo que ainda <b>espera um vencedor</b> continua sem os botões, porque ainda não há com quem combinar. <b>Nenhum jogo, dupla ou resultado foi alterado.</b></li>' +
        '<li><b>👆 O “ver mais/ver menos” do progresso voltou a obedecer ao toque:</b> no cartão de progresso, tocar em <b>ver mais</b> ou <b>ver menos</b> muitas vezes não fazia nada — e, pior, <b>abria o torneio</b> sem que ninguém pedisse. O motivo: o cartão redesenha sozinho para o <b>relógio da regressiva</b> andar, e esse redesenho podia acontecer <b>entre o encostar e o soltar do dedo</b>. O botão em que você tocou deixava de existir no meio do caminho, e o toque acabava caindo no card inteiro, que leva para o torneio. Agora o cartão <b>espera você soltar</b> antes de se redesenhar. O relógio continua andando normalmente para quem não está tocando em nada.</li>' +
        '<li><b>✓ O “Confirmar” voltou a esperar o placar, também na tela inicial:</b> no card <b>“Seu próximo jogo”</b> da tela inicial, o botão <b>✓ Confirmar</b> aparecia junto do <b>📡 Ao Vivo</b> com o placar ainda em <b>0-0</b> — dois caminhos oferecidos ao mesmo tempo, sendo que um deles ainda não fazia sentido. Na chave do torneio já era do jeito certo. Agora é igual nas duas telas: enquanto não há placar escrito nos <b>dois lados</b>, só aparece o <b>Ao Vivo</b>; ao digitar, o <b>Confirmar</b> toma o lugar dele — e apagar o que foi digitado traz o <b>Ao Vivo</b> de volta.</li>' +
        '<li><b>⏱️ Agora dá para esticar uma rodada e encurtar outra:</b> nas <b>datas da fase</b>, apareceu uma <b>régua com as rodadas</b>. Cada divisão mostra a <b>data (dd/mm)</b> e cada trecho, <b>quantos dias</b> aquela rodada dura — e as divisões se <b>arrastam</b>. Serve para dar mais tempo a uma rodada cheia e menos a uma curta, sem mexer no <b>início</b> nem no <b>fim</b> da fase, que continuam sendo os que você definiu. <b>O padrão não mudou:</b> sem tocar em nada, as rodadas continuam com o <b>mesmo número de dias</b> cada uma — a régua é só o ajuste fino, e há um link para voltar ao padrão quando quiser. Se depois você mudar as datas ou o número de rodadas, o ajuste antigo é <b>descartado sozinho</b> e volta a divisão igual, para nunca sobrar uma rodada com prazo sem sentido.</li>' +
        '<li><b>✏️ O “Editar” do card do torneio voltou a abrir:</b> clicar em <b>Editar</b> no card às vezes simplesmente <b>não fazia nada</b> — sem aviso, sem erro. Dependia de você ter aberto a tela de <b>criar torneio</b> antes, naquela mesma visita: a janela de edição só era montada nessa hora, e sem ela o botão não tinha o que abrir. Por isso parecia que funcionava “às vezes”. Agora o botão <b>monta a janela na hora</b> e abre. E se algum dia faltar alguma coisa, ele <b>avisa</b> em vez de ficar mudo.</li>' +
        '<li><b>💬 O balãozinho do WhatsApp voltou — agora em TODO card de jogo:</b> ao lado do nome de cada pessoa, na chave, aparece o <b>💬</b> que abre a conversa direto no WhatsApp. Antes ele só existia na <b>classificação</b>, e é no card do jogo que você está olhando na hora de combinar. Vale a mesma regra de sempre: o <b>organizador</b> fala com todo mundo; o <b>participante</b> vê o balãozinho de <b>quem joga com ele</b>. Ninguém vê o próprio, quem <b>escondeu o número</b> no perfil continua escondido, e o toque no balãozinho <b>não lança placar</b> por engano.</li>' +
        '<li><b>🔎 A busca da chave voltou a achar:</b> digitar o nome de alguém no <b>Buscar</b> do chaveamento podia deixar a tela <b>vazia</b>, mesmo com a pessoa aparecendo num card ali na frente. Acontecia quando o nome que você lê no card chega <b>depois</b> do desenho (o app atualiza o nome pelo perfil) — a busca ainda procurava pelo texto antigo, não achava ninguém, e “nenhum resultado” esconde tudo. Agora a busca também casa com <b>o que está escrito no card</b>: se você está lendo o nome na tela, a busca acha. Buscar por quem <b>trocou o nome</b> no perfil continua funcionando, e busca sem resultado continua mostrando vazio — quando for vazio de verdade. <b>Correção logo em seguida:</b> por algumas horas a busca passou a mostrar <b>tudo</b> em vez de filtrar, porque ela também estava lendo o texto dos <b>botões</b> do card — digitar “ar” encontrava “Apl<b>ic</b>ar”. Agora ela lê apenas os <b>nomes</b>. <b>E agora ela acha também quem ainda está carregando:</b> em torneio grande, procurar por alguém de um grupo que você ainda não abriu podia não achar — o nome dessa pessoa só chega do <b>perfil</b> depois que o card aparece, e até lá não havia texto nenhum para casar. Agora cada card leva consigo <b>a identidade de quem joga</b>: a busca percebe que ainda não sabe o nome, <b>vai buscar o perfil</b> e refaz a procura sozinha. Enquanto isso ela <b>não para de filtrar</b> — quem já é conhecido e não casa continua escondido —, e só o card cujo nome falta <b>fica visível até o nome chegar</b>, em vez de sumir por engano. Cada pessoa é buscada <b>uma vez só</b>, então digitar letra por letra não deixa a busca mais lenta. <b>E a busca da chave passou a conhecer o nome do cadastro:</b> em torneio grande, a chave é desenhada antes de a lista de inscritos chegar, e cada card guardava só o nome <b>gravado no sorteio</b>. Se a pessoa aparece na tela de <b>Inscritos</b> com outro nome (o do cadastro), você achava lá e não achava na chave. Agora a chave procura também pelo nome do cadastro, o mesmo que Inscritos usa — sem gravar nada novo.</li>' +
        '<li><b>💬 O balãozinho ficou junto do nome:</b> ele tinha nascido no canto do card, perto do <b>placar</b>, porque a caixa do nome tem largura fixa. Agora fica <b>colado no nome de cada atleta</b>, em nome curto e em nome longo — e nenhum nome passou a ser cortado por causa disso.</li>' +
        '<li><b>🔢 O placar por sets voltou ao tamanho grande:</b> em <b>melhor de 3</b> e <b>melhor de 5</b>, o número do placar, o <b>campo onde você digita</b> e o <b>“0” de quem ainda não jogou</b> estavam cada um num tamanho diferente — e todos menores que no jogo de <b>1 set</b>. Por isso, ao avançar de fase, o placar parecia ter encolhido. Agora os três seguem a <b>mesma régua</b> e usam o maior tamanho que cabe na coluna. <b>O nome dos jogadores não perdeu espaço:</b> a largura das colunas continua a mesma — só o número ficou maior dentro dela.</li>' +
        '<li><b>⏱️ O cartão da rodada passou a falar da RODADA — e a fase avançada conta como iniciada:</b> na fase seguinte, o cartão misturava três coisas erradas. Mostrava <b>“0/99 jogos”</b>, que é a fase <b>inteira</b>, ao lado de um prazo que é de <b>uma rodada só</b>; anunciava <b>datas da fase anterior</b> (um início e um fim que já tinham passado); e dizia <b>“Aguardando início”</b> mesmo com a fase já sorteada e as duplas publicadas. Agora o contador é o da <b>rodada atual</b> (o total da fase e do torneio continuam na linha <b>🏆 Torneio completo</b>, onde sempre estiveram), a fase <b>avançada aparece em andamento</b> com a <b>regressiva correndo</b>, e as datas saem do <b>início da fase</b> — o momento em que o organizador avançou — até o <b>fim que ele configurou</b>, divididos pelo número de rodadas. <b>Sem data confiável, o app não inventa uma:</b> mostra a duração estimada e diz que está aguardando.</li>' +
        '<li><b>🎾 A chave da fase seguinte voltou a aparecer no celular:</b> em torneio grande, ao abrir o <b>Chaveamento</b> da fase nova, a tela mostrava o título <b>“FASE 2 · Eliminatória”</b> e, embaixo, <b>nada</b> — sem erro e sem aviso de carregamento. Não era o aparelho nem a internet: num torneio grande os jogos ficam <b>guardados à parte</b> do resto do torneio, e a tela da chave <b>não sabia esperar por eles</b> — desenhava o que tinha (nada) e parava ali. No computador costumava funcionar porque os jogos já tinham sido buscados antes. Agora, enquanto eles estão a caminho, aparece <b>“Carregando chaveamento…”</b>, e a chave <b>aparece sozinha</b> assim que chegam. Se a busca falhar, a tela <b>diz isso</b> e oferece <b>“Tentar de novo”</b>, em vez de ficar girando. <b>Nenhum jogo, dupla ou resultado foi alterado</b> — o que faltava era a tela, não o dado.</li>' +
        '<li><b>📅 Avançar de fase passou a marcar o início da fase nova:</b> o painel da rodada mostrava, na fase seguinte, as <b>datas da fase anterior</b> — um início e um fim que já tinham passado. Acontecia porque o app não guardava <b>quando</b> a fase nova havia começado, e acabava reaproveitando as datas da primeira fase. Agora o <b>momento em que o organizador avança</b> fica registrado e vale como <b>início da fase</b>; o <b>fim</b> continua sendo o que o organizador lançou para ela. O prazo de cada rodada segue a régua de sempre — o período da fase <b>dividido pelo número de rodadas</b>. Para torneios que <b>já avançaram</b> antes desta versão, o app usa o instante em que a fase anterior foi encerrada, que é o mesmo momento do avanço. Se você declarou datas próprias para a fase, <b>elas continuam mandando</b>.</li>' +
        '<li><b>🔒 O sandbox de teste ficou realmente privado — e virou cópia exata:</b> o sandbox é uma cópia de treino de um torneio, que só o desenvolvedor usa. Duas coisas estavam erradas nele. Primeiro, <b>ele não era invisível de verdade</b>: quem participava do torneio original conseguia, sabendo o caminho, chegar aos dados do sandbox — inscritos, jogos, grupos, histórico. Segundo, para escondê-lo o app <b>mexia na lista de participantes</b> da cópia, então ela deixava de ser fiel ao torneio. Agora o sandbox mora num lugar separado, ao qual <b>só o dono dele tem acesso</b>, e por isso a cópia pôde voltar a ser <b>exata</b>: inscritos, jogos, fases, classificações publicadas, W.O., lista de espera, histórico e barras de progresso iguais ao original. E ela é <b>montada e conferida no servidor</b>: se não bater com o original, o sandbox <b>não é criado</b> — nada pela metade. <b>Nada disso toca os torneios de verdade:</b> eles continuam exatamente como estavam.</li>' +
        '<li><b>🧪 O sandbox virou cópia fiel do torneio — inscritos, jogos e barras completos:</b> ao criar um sandbox de um torneio grande, ele nascia <b>incompleto</b>: aparecia com <b>14 inscritos e nenhum jogo</b> em vez dos 152 e 115 reais. A tela então mostrava <b>“…” no lugar do número de inscritos</b>, não sabia se você estava inscrito e <b>perdia as barras de progresso</b>. Causa: a cópia era feita a partir do que estava <b>na tela</b> naquele instante, e num torneio grande a lista e os jogos chegam alguns instantes depois. Agora o app <b>lê o torneio original inteiro</b> antes de copiar e <b>confere</b> que a cópia bate com o original — inscritos, jogos, fases, classificações já publicadas, W.O., lista de espera e histórico. <b>Se não bater, o sandbox não é criado</b>: nada pela metade, e você pode tentar de novo. O mesmo vale pro <b>Resetar</b>. <b>Isso é só do sandbox</b> — nenhum torneio de verdade foi tocado.</li>' +
        '<li><b>🔴 Quem não jogou a fase não entra na eliminatória:</b> ao avançar, a tela mostra quem <b>desativou a participação</b> e quem <b>levou W.O.</b>, com os <b>nomes em vermelho</b>. Nenhuma dessas pessoas ganha vaga por uma opção da tela: elas não têm classificação na fase. Antes dos nomes, o organizador escolhe uma única decisão para todos: <b>manter no torneio</b>, desativados e reativáveis para o fim da lista de espera, ou <b>excluir definitivamente do torneio</b>. Jogos, W.O. e classificação já registrados continuam no histórico.</li>' +
        '<li><b>✅ Cancelar e confirmar sempre à mão, no topo da tela:</b> nas telas de avançar fase, os botões ficavam no fim do conteúdo — em torneio grande, com muitas linhas, você precisava rolar até o fim pra achar. Agora <b>Cancelar</b> e <b>Confirmar</b> (ou <b>Seguir</b>) ficam <b>fixos no topo</b>, sempre visíveis. E a escolha passou a ser em dois tempos: você <b>seleciona</b> a opção e depois <b>confirma</b> — não dá mais pra avançar sem querer, com um toque só. <b>Cancelar não muda nada</b> no torneio.</li>' +
        '<li><b>🧹 Só um botão de “Avançar de Fase” nas Ferramentas do Organizador:</b> quando a fase termina e existe uma próxima, as <b>Ferramentas do Organizador</b> mostravam <b>dois</b> botões de avançar, lado a lado — com nomes e cores diferentes, mas fazendo <b>exatamente a mesma coisa</b>. Agora é <b>um só</b>. <b>Nada mudou no que ele faz:</b> mesma pergunta de promoção de linha quando for o caso, mesmo sorteio da próxima fase. O botão de avançar que aparece <b>dentro da chave</b> é outra coisa e continua onde estava.</li>' +
        '<li><b>⬆️ O aviso de “linha ímpar” voltou a aparecer na hora de avançar de fase:</b> quando a próxima fase tem <b>duas linhas</b> (por exemplo Ouro e Prata) e cada uma fica com um número <b>ímpar</b> de duplas, uma dupla de cada linha acabaria <b>sem adversário</b>. O app tem uma tela que oferece a solução — <b>subir a melhor dupla</b> da linha de baixo pra de cima, deixando as duas linhas pares — mas em torneios com <b>muitos grupos</b> ela simplesmente não aparecia: o app estava <b>contando as duplas errado</b> antes de perguntar, e concluía que não havia nada a decidir. Agora ele conta do mesmo jeito que monta a chave, e a pergunta aparece quando deve. <b>A decisão continua sendo do organizador</b> — dá pra promover ou seguir com folga/repescagem —, e quem sobe é a <b>dupla inteira</b>, a melhor da linha de baixo. <b>Nenhuma chave já sorteada muda.</b></li>' +
        '<li><b>🥈 A promoção entre linhas agora olha a dupla inteira:</b> quando você escolhe equilibrar duas linhas ímpares, a dupla promovida é escolhida pelo <b>desempenho combinado dos dois integrantes</b> — vitórias, pontos e saldos somados — seguindo a <b>ordem de desempates que você configurou</b>. Antes, bastava uma pessoa ter ido bem para promover uma dupla mesmo que o parceiro derrubasse o resultado. A dupla que subiu fica identificada no <b>primeiro jogo eliminatório</b> com a etiqueta prata <b>PROMO</b>; como a REP, ela não acompanha vitórias para outras rodadas.</li>' +
        '<li><b>🏅 Cabeças de chave agora consideram a dupla inteira:</b> Ouro e Prata são semeadas pelo <b>desempenho combinado da dupla</b>, incluindo o saldo de games somado e os desempates escolhidos pelo organizador — a mesma régua usada para promover uma dupla. As melhores ficam em lados opostos da chave para se encontrarem o mais tarde possível: numa chave de oito, por exemplo, a 1ª e a 2ª só podem chegar juntas à final.</li>' +
        '<li><b>🏆 As duplas da fase seguinte saem exatamente da classificação publicada:</b> quando um grupo termina, a ordem que aparece na tela vira <b>fato</b> — é dela que saem as duplas da próxima fase. Só que, na hora de avançar, o app estava <b>recalculando</b> essa ordem em vez de usar a publicada, e o resultado podia sair diferente do que todo mundo já tinha visto: quem <b>jogou e perdeu</b> caía abaixo de quem <b>não jogou</b>, duplas se formavam trocadas e alguém podia ficar <b>sem parceiro</b>. Agora o avanço usa a mesma classificação que está na tela. Classificam <b>1º a 4º</b> de cada grupo; do 5º em diante ninguém avança — vale a <b>posição</b>, seja atleta, vaga em aberto ou W.O. As duplas seguem a escolha do organizador: <b>Performance</b> junta 1º+2º e 3º+4º; <b>Equilíbrio</b> junta 1º+4º e 2º+3º.</li>' +
        '<li><b>🔢 A contagem de rodadas não recomeça quando a fase vira:</b> num torneio de várias fases, a primeira rodada da fase seguinte aparecia como <b>“Rodada 1”</b> de novo — mesmo com a Rodada 1 já concluída —, e o número de jogos mostrado era só o da <b>primeira chave</b>, não o da fase inteira. Agora ela aparece como <b>Rodada 2</b>, com o <b>total de jogos daquela fase</b>. O progresso do torneio inteiro continua na mesma barra de sempre.</li>' +
        '<li><b>📋 A classificação da fase anterior fica enxuta depois que a fase avança:</b> ela vira <b>histórico</b> — não serve mais pra operar jogo nenhum —, então passa a mostrar só <b>Posição, Jogador, V e Saldo</b>. No celular isso devolve bastante espaço pro <b>nome</b>, que antes quebrava uma palavra por linha. <b>Enquanto a fase não avança, a tabela continua completa.</b> Nenhum número, critério de desempate ou W.O. mudou — é só o que aparece.</li>' +
        '<li><b>🔎 A busca da chave para de descolar do topo no celular:</b> ao procurar alguém na chave, a lista encolhe — e o <b>cabeçalho com a busca</b> subia junto e sumia, principalmente depois de limpar no <b>✕</b>. Agora ele fica fixo no topo do começo ao fim: durante a digitação, com o filtro aplicado, depois de limpar, rolando bastante e com o <b>teclado abrindo e fechando</b>. A busca continua sendo <b>uma só</b>, com o foco no campo pra você já digitar de novo — e a rolagem <b>não anda sozinha</b>.</li>' +
        '<li><b>⏳ O número de inscritos parou de oscilar no celular:</b> em torneios grandes a lista de inscritos e os jogos chegam alguns instantes depois do resto. Nesse intervalo o card <b>alternava</b> entre “… inscritos” e um número, e a <b>chave às vezes não desenhava</b> — como se não existisse. Agora, enquanto o app não tem a lista inteira, ele diz que <b>está carregando</b> em vez de mostrar um número que ainda vai mudar, e não trata a chave como ausente antes de terminar de carregar. Quando o resto chega, o número e a chave aparecem <b>sozinhos</b>, sem recarregar nada. E o botão <b>“Inscrever-se”</b> deixa de aparecer num torneio que já tem chave só porque os jogos ainda estavam a caminho.</li>' +
        '<li><b>⚠️ A ficha do torneio avisa quando o sorteio automático não vai acontecer:</b> se o torneio está marcado pra sortear sozinho mas o app <b>não consegue determinar o fuso do local</b>, o organizador (e os co-organizadores) passam a ver um aviso <b>na própria ficha do torneio</b> — não só na tela de criar/editar, por onde se passa uma vez só. O aviso diz que o <b>sorteio manual continua disponível</b>, explica o que resolve e traz um botão pra <b>editar o torneio</b> na hora. Ele <b>some sozinho</b> assim que o local ou a sua cidade passam a resolver o fuso. Quem não organiza não vê nada disso.</li>' +
        '<li><b>📍 O local do torneio agora vale pro sorteio automático:</b> quando você escolhe o local na busca, o app passa a guardar também a <b>cidade, o estado e as coordenadas</b> do lugar — e é isso que permite saber o <b>fuso horário do evento</b> e sortear na hora certa, inclusive fora do seu estado. <b>Nada muda no que você faz:</b> é a mesma busca de sempre. E se o fuso ainda não puder ser determinado, a tela <b>avisa</b> em vez de prometer um sorteio que não vai acontecer — dizendo o que resolve (escolher o local na busca, ou preencher a sua <b>cidade</b> no perfil). O <b>sorteio manual continua disponível normalmente</b> nesse meio-tempo.</li>' +
        '<li><b>🔒 A fila de e-mails do app ficou trancada:</b> os e-mails que o scoreplace envia — convites, confirmação de conta, redefinição de senha — ficam numa fila até serem entregues. Até agora, <b>qualquer pessoa logada</b> conseguia colocar uma mensagem nessa fila e escolher <b>para quem</b>, com que <b>assunto</b> e com que <b>texto</b>, saindo do endereço oficial do scoreplace. Agora só o <b>servidor</b> escreve nela: ninguém consegue mais usar o app pra mandar e-mail em nome do scoreplace. <b>Nada mudou pra você:</b> os convites e os e-mails de sempre continuam chegando normalmente — eles passaram a ser montados e enviados pelo servidor nas últimas atualizações.</li>' +
        '<li><b>📨 O convite de co-organização parou de falhar de vez em quando:</b> o app pedia o e-mail do convite <b>antes de terminar de salvar</b> o convite — e às vezes o servidor ainda não o via, então o e-mail simplesmente não saía, mesmo com a tela dizendo <b>“convite enviado”</b>. Agora o app espera o convite ficar salvo antes de avisar qualquer pessoa. E a tela passou a dizer a verdade: se o e-mail não puder ser enviado, ela avisa que o convite <b>está registrado no app</b> mas o e-mail não saiu — em vez de dizer que foi enviado. Se o convite não conseguir ser salvo, ele não aparece mais como se tivesse sido feito.</li>' +
        '<li><b>🤝 Convites de dupla e de co-organização ficaram mais seguros:</b> esses dois convites chegam por e-mail com os botões <b>Aceitar</b> e <b>Recusar</b> — e continuam funcionando exatamente igual. O que mudou é <b>quem escreve a mensagem</b>: antes ela era montada no seu navegador, agora é montada no <b>servidor</b>, que confere se o convite realmente existe antes de enviar qualquer coisa. Na prática, ninguém consegue mais usar o app pra disparar e-mail em nome do scoreplace pra quem quiser. Também não sai mais <b>e-mail repetido</b> do mesmo convite se a conexão engasgar — e se a pessoa recusar e você convidar de novo, o novo convite chega normalmente. Quem desligou os e-mails nas preferências continua sem receber.</li>' +
        '<li><b>🖥️ A tela inicial passou a se atualizar sozinha quando os dados chegam:</b> em torneios grandes os inscritos e os jogos chegam alguns instantes depois do resto. Até agora, quando eles chegavam, a <b>tela não era redesenhada</b>: ficava com “…” no lugar do número de inscritos, com “Carregando…” no botão e sem <b>“Novidades no seu torneio”</b> — mesmo com tudo já carregado por baixo. Só sair da tela e voltar resolvia. Agora ela se redesenha <b>uma única vez</b>, assim que os dados chegam, e mostra o número real, sua inscrição, seus torneios e as novidades. <b>Nada mais mudou:</b> um placar lançado ou uma presença marcada continuam <b>não</b> redesenhando a tela — era isso que causava a piscada e o toque que não pegava de primeira. E a lista <b>Explorar</b> voltou a carregar: ela estava falhando por um detalhe interno e vinha vazia.</li>' +
        '<li><b>👤 O aviso “você não está inscrito” só aparece quando o app tem certeza:</b> esse aviso fica no topo da tela do torneio e da lista de inscritos, e existe pra você não precisar procurar seu nome numa lista de mais de cem pessoas. Só que, em torneios grandes, ele dava a resposta <b>antes de a lista de inscritos terminar de chegar</b> — e podia dizer que você não estava inscrito estando. Agora, enquanto a lista não chega, ele diz que <b>está carregando</b>; se a leitura falhar, diz isso e oferece <b>“Tentar novamente”</b>. Quando a lista chega, ele mostra sua situação real, com seu <b>número de inscrição</b>. O aviso de não inscrito continua existindo — só que agora ele só aparece quando é verdade. <b>Lista de espera, desativado e W.O.</b> seguem aparecendo como antes.</li>' +
        '<li><b>🔄 Quando algo não carrega, agora o app avisa — e você pode tentar de novo:</b> em torneios grandes, se a leitura da lista de inscritos falhar por conexão, o app tenta sozinho algumas vezes. Antes, quando essas tentativas acabavam, a tela <b>continuava mostrando “Carregando…” para sempre</b>, e a única saída era fechar e abrir o app. Agora ele diz claramente que <b>não conseguiu carregar</b> e mostra um botão <b>“Tentar novamente”</b>. Seus jogos e sua inscrição continuam salvos — o que falhou foi a leitura, não o dado. E o app <b>não te desloga nem recarrega a página</b>: o botão refaz só a busca daquele torneio. Se os dados chegarem sozinhos enquanto o aviso está na tela, ele <b>some sem você fazer nada</b>.</li>' +
        '<li><b>✅ Quem está inscrito não aparece mais como “não inscrito”:</b> em torneios grandes, a lista de inscritos é guardada separada do torneio e chega alguns instantes depois. Nesse intervalo o app concluía que <b>você não estava inscrito</b> — e mostrava o botão “Inscrever-se” pra quem já estava, além de contagens menores do que a real. Nada disso vinha do banco: os inscritos estavam todos lá o tempo todo. Agora, enquanto a lista não chega, o app diz <b>“⏳ Carregando…”</b> em vez de dar uma resposta errada, e assim que ela chega tudo aparece sozinho, sem recarregar. Pra quem <b>organiza</b>, era esse mesmo intervalo que fazia <b>“Novidades no seu torneio”</b> e <b>“Seus últimos resultados”</b> sumirem da tela inicial. E se a leitura falhar por conexão, o app <b>tenta de novo sozinho</b> — antes ele desistia em silêncio e a tela ficava incompleta até você fechar e abrir o app.</li>' +
        '<li><b>🔄 A tela não abre mais misturando duas versões do app:</b> depois de uma atualização, o aparelho podia carregar a <b>página de uma versão antiga junto com o programa da versão nova</b>. Nada estava perdido — os inscritos, os placares e as novidades seguiram guardados o tempo todo —, mas a tela abria mostrando <b>contagens erradas, “Novidades” vazia e resultados antigos</b>, e só recarregar resolvia. Agora, com internet, o app sempre busca a página nova antes de usar a guardada, e ele mesmo percebe quando as duas metades não combinam e se atualiza. <b>Sem internet o app continua abrindo normalmente</b>, com a última versão completa que você já tinha. E enquanto os dados de um torneio grande ainda estão chegando, o número de inscritos aparece como <b>“…”</b> e a seção diz que está carregando — em vez de dizer <b>zero</b>, que era a parte que mais confundia.</li>' +
        '<li><b>📨 Convidar por e-mail agora é só de quem organiza:</b> o campo <b>"Convide por e-mail"</b> na tela do torneio aparecia para qualquer pessoa e o e-mail saía direto do navegador. Agora ele é exclusivo do <b>organizador e dos co-organizadores</b>, e quem monta a mensagem é o servidor — o convite sempre sai com o nome, a data e o local certos do torneio. Há um limite de <b>20 convites por dia por torneio</b> e uma pausa de 2 minutos antes de reenviar para o mesmo endereço, pra ninguém usar o convite como disparador de mensagem.</li>' +
        '<li><b>🧹 A tela inicial ficou mais limpa:</b> os filtros <b>"Pra Você"</b> e <b>"Organizados"</b> saíram — eram atalhos que ninguém pediu e que só ocupavam espaço. <b>Explorar</b> continua onde estava. Os outros filtros agora <b>desligam quando você clica neles de novo</b>, então dá pra voltar à lista completa sem procurar botão nenhum.</li>' +
        '<li><b>🏆 Placar, classificação e W.O. voltaram a aparecer:</b> em torneios grandes, a tela podia abrir com <b>tudo zerado</b> — classificação em 0, "Demais jogos da rodada (0)", W.O. e jogadores inativos sumidos. Nada disso tinha se perdido: os jogos e os placares seguiram guardados o tempo todo. O app checava se já tinha os jogos perguntando apenas <b>se existia algum</b> — e bastava um único registro solto para ele concluir que já tinha todos e parar de buscar os outros. Agora ele confere <b>quantos</b> deveria ter, e faz essa conferência <b>também na primeira tela</b>, aquela que aparece instantaneamente a partir do que ficou guardado no aparelho. Era por ali que o problema continuava passando: a lista abria com os dados incompletos e ninguém pedia o resto até você abrir o torneio.</li>' +
        '<li><b>📧 Confirmar um e-mail extra ficou mais seguro:</b> quando você adiciona um segundo e-mail ao seu perfil, o link de confirmação passou a ser criado <b>no servidor</b>, e não mais no seu navegador. O link continua chegando na caixa do e-mail que você digitou — é isso que prova que ele é seu —, mas agora ele <b>só pode ser usado uma vez</b> e vincula o endereço <b>exclusivamente à conta que pediu</b>, mesmo que você abra o link em outro navegador ou logado em outra conta. Isso importa porque um e-mail vinculado ajuda a te identificar quando você entra no app. E se você clicar em enviar duas vezes seguidas — ou a conexão engasgar e o pedido repetir — chega <b>um e-mail só</b>, não dois com links diferentes.</li>' +
        '<li><b>🚫 O W.O. agora chega no jogo, e não só na lista:</b> em torneios grandes, aplicar um W.O. registrava a troca e a classificação, mas quem saiu <b>continuava escalado nas partidas</b> daquele grupo — e quem entrou no lugar podia sumir da lista de inscritos. Agora a substituição chega em tudo sozinha, em segundos: a pessoa que entrou aparece nos jogos e na lista, e a que saiu é desativada e não volta a ser sorteada. Partidas que <b>já têm placar</b> não são alteradas — o que foi jogado, foi jogado.</li>' +
        '<li><b>🪦 Contas unificadas param de sumir:</b> quando alguém cria uma conta nova e ela é unida à antiga, ficava um vínculo ligando as duas — e é ele que faz os jogos antigos continuarem mostrando a pessoa certa. Uma limpeza automática podia apagar esse vínculo cedo demais, e aí o nome dela desaparecia dos jogos. Esse vínculo agora é permanente.</li>' +
        '<li><b>👤 Quem não tem mais conta volta a aparecer pelo nome:</b> no card do jogo, uma pessoa podia aparecer como <b>“…”</b> em vez do nome. O app mostra sempre o nome atual do perfil de cada pessoa — assim, quem muda o nome aparece atualizado em todo lugar. Só que, quando a conta <b>não existe mais</b>, não há perfil de onde tirar o nome, e o “…” ficava para sempre. Agora, nesse caso o app usa o nome que ficou <b>guardado no próprio jogo</b>. Enquanto o perfil está só carregando, o “…” continua aparecendo — ele quer dizer <b>“já volto”</b>, e não o nome errado.</li>' +
        '<li><b>🔄 O torneio não esvazia mais a tela até você recarregar:</b> em torneios grandes, os jogos ficam guardados em registros separados do torneio. Depois de uma ação como um <b>W.O.</b>, a tela podia voltar <b>sem nada</b> — <b>0 jogos na rodada</b>, classificação zerada e só um W.O. na lista — e só recarregar a página trazia tudo de volta. Nada nunca se perdeu: os jogos e os placares seguiram guardados o tempo todo; era o app que, depois de buscar esses registros uma vez, <b>nunca mais tentava buscar de novo</b> naquela sessão. Agora ele tenta quantas vezes precisar e a tela se recompõe sozinha.</li>' +
        '<li><b>⏱️ A lista de espera volta a andar sozinha:</b> quando já há quatro pessoas prontas para jogar, o sistema forma o novo grupo automaticamente também nos torneios grandes. Antes, esses torneios podiam ficar com a fila parada mesmo tendo gente suficiente.</li>' +
        '<li><b>✅ Resultados de torneios grandes acompanham os jogos:</b> placar, W.O. e quem joga em cada partida continuam sincronizados mesmo quando o torneio guarda os jogos em registros separados. Assim, um resultado não fica preso numa cópia antiga nem some da lista de partidas.</li>' +
        '<li><b>🛠️ O agendador de torneios ficou mais confiável:</b> uma dependência antiga que já não faz parte do aplicativo podia impedir uma atualização do sistema de sorteio. Ela foi removida do processo de publicação.</li>' +
        '<li><b>⭐ A estrela da organização voltou para junto do nome:</b> ela fica logo à direita, com uma pequena folga, em vez de perdida no meio do card. E uma conta que tenha sido unificada agora leva seu nome e foto atuais para os jogos que ainda apontavam para o UID antigo.</li>' +
        '<li><b>🧩 Jogador X não é uma pessoa em outro grupo:</b> o coringa continua sendo uma vaga independente em cada posição. Por isso ele nunca mais recebe a indicação de que está jogando em outro grupo — essa anotação fica apenas para uma pessoa real que saiu por W.O. e reapareceu depois.</li>' +
        '<li><b>🎾 Cada Jogador X agora é uma vaga própria:</b> o coringa não é uma pessoa cadastrada. Pode completar mais de uma vaga — inclusive até três no mesmo grupo — sem que um W.O. ou uma troca afete os demais. Quando há nomes iguais, o app distingue as vagas internamente e mostra qual delas está sendo substituída; a atualização também força o navegador a carregar esses scripts novos.</li>' +
        '<li><b>📛 Os nomes da organização pararam de vibrar e cortar:</b> o card agora usa uma caixa estável para medir o nome, então a hidratação do perfil não entra mais num ciclo de redimensionamento. A coroa continua junto do nome.</li>' +
        '<li><b>🔎 Buscar um jogador agora mostra o contexto inteiro:</b> encontrar um <b>Jogador X</b> mantém visíveis o grupo, a classificação, todos os jogos daquela rodada e os registros de espera, inativo e W.O.; para pessoas reais, a busca continua mostrando só os jogos delas. O número em <b>Demais jogos da rodada</b> voltou a informar o total real da seção, sem virar zero por causa do filtro.</li>' +
        '<li><b>🚫 W.O. voltou a mostrar a fila inteira na primeira confirmação:</b> a confirmação tinha virado uma tela longa que mostrava só uma pessoa e escondia a escolha que já existia. Agora <b>Cancelar</b> e <b>Confirmar</b> ficam no topo, a lista de espera aparece com seleção, uma pessoa escolhida <b>assume a vaga na hora</b>, várias recebem convite, e a alternativa de <b>Jogador X</b> continua disponível.</li>' +
        '<li><b>👤 Todo card de pessoa tem a mesma largura e o mesmo respiro:</b> na tela do torneio, o cartão de quem organiza ocupava a <b>linha inteira</b> enquanto os inscritos apareciam dois por linha. A causa era mais funda: existiam <b>três regras de layout diferentes</b> para o mesmo card — uma na tela de inscritos, outra no detalhe do torneio, e uma terceira que nenhuma das duas usava. Ao unificar, o espaçamento entre os cards chegou a <b>encolher pela metade</b> numa das telas. Agora é uma regra só, com a medida das telas que você já usava, e o espaçamento voltou ao que era.</li>' +
        '<li><b>🏆 Abrir um torneio abre a ficha dele:</b> tocar o card na tela inicial não joga mais a pessoa na chamada. <b>Antes do sorteio</b>, a ficha mostra as informações, as ferramentas e os cards dos inscritos abaixo de quem organiza. <b>Depois do sorteio</b>, presença, W.O. e exclusão ficam somente no botão <b>Inscritos</b>, na sua tela própria.</li>' +
        '<li><b>🧹 Uma versão de cada cartão, e só uma:</b> o cartão de participante tinha ganhado uma <b>segunda versão</b>, usada só em caso de falha — e é assim que as diferenças voltam: a cópia nasce simples, alguém a melhora sozinha, e as duas telas param de combinar. Ela foi apagada, e o app passa a ter <b>uma trava</b> que impede qualquer cartão novo de aparecer fora dos três oficiais.</li>' +
        '<li><b>↔️ Os botões do card de inscrito voltaram para a direita:</b> em cartões estreitos, <b>Ausente</b>, <b>Aplicar W.O.</b> e o <b>✕</b> apareciam encostados à esquerda, embaixo do nome. O cartão sempre foi o mesmo — o que acontecia é que, sem espaço, esses botões desciam para uma segunda linha e perdiam o alinhamento à direita no caminho. Agora eles ficam à direita cabendo na linha ou quebrando.</li>' +
        '<li><b>🔑 Entrar não devolve mais você para a porta:</b> ao fazer login pela tela inicial, existia um instante em que o app ainda não tinha a sua sessão e mostrava de novo a <b>página inicial ou a tela de login</b> — como se nada tivesse acontecido. Quem estava entrando concluía que falhou e tentava outra vez, no meio de um login que estava dando certo. Agora, enquanto a entrada é processada, aparece o <b>"Entrando…"</b> no lugar. Se algo der errado de verdade, a tela inicial volta sozinha em poucos segundos — ninguém fica preso esperando.</li>' +
        '<li><b>📋 Torneios encerrados viraram uma lista, com "ver mais":</b> a seção ficava atrás de uma linha discreta que quase ninguém percebia, e abria cartões grandes. Agora ela usa o mesmo <b>ver mais / ver menos</b> das outras seções e mostra os torneios em <b>linhas compactas</b> — dá pra achar um torneio antigo de relance, em vez de rolar cartão por cartão.</li>' +
        '<li><b>🚫 Remover um participante agora remove de verdade:</b> ao tirar alguém da lista, uma <b>proteção interna</b> — criada para impedir que uma tela desatualizada apague gente sem querer — entendia a remoção como acidente e <b>devolvia a pessoa</b>, no fim da fila. O caminho de remoção do organizador nunca dizia ao sistema que a saída era intencional; agora diz. A proteção continua valendo para todo o resto.</li>' +
                '<li><b>🔢 O número de inscrição deixou de embaralhar ao formar e desfazer duplas:</b> quem era o inscrito 1 e o 2 voltava como 7 e 8 depois de formar a dupla e desfazê-la, empurrando todo mundo de lugar. O número <b>é da pessoa</b>: ele acompanha cada um pra dentro da dupla e volta com ele quando ela se desfaz. A única coisa que muda um número continua sendo alguém <b>anterior sair</b> — aí a fila se fecha e todos depois dele sobem uma posição, sem buraco.</li>' +
        '<li><b>🚫 Participante removido que voltava sozinho:</b> ao tirar um inscrito da lista, ele reaparecia na atualização seguinte. Dois inscritos sem conta acabavam gravados no <b>mesmo lugar</b>, um por cima do outro — apagar um trazia o outro de volta no lugar dos dois. Cada inscrito passa a ter o seu próprio registro, e remover remove.</li>' +
        '<li><b>⏱️ A previsão de duração contava jogos a mais (ou a menos):</b> num torneio de <b>duplas</b>, a estimativa tratava cada pessoa como um competidor — 8 inscritos viravam uma chave de 8 em vez dos 4 times que realmente jogam. E a <b>disputa de 3º lugar</b> ficava fora da conta, embora seja jogada sempre. Os dois erros puxavam a previsão do dia para lados opostos; agora ela conta <b>times</b> e <b>todos os jogos que vão acontecer</b>.</li>' +
        '<li><b>💬 O grupo oficial do torneio foi para o lado do botão de inscrição:</b> quem ainda não estava inscrito encontrava esse botão lá embaixo, na fila do Convidar/Compartilhar, enquanto quem já estava o via junto do próprio botão. Agora ele fica à <b>esquerda do "Inscrever-se"</b> nos dois casos.</li>' +
        '<li><b>🏆 O pódio aparece assim que a final é lançada:</b> ao lançar o último jogo, o torneio era encerrado corretamente no servidor — mas a tela continuava mostrando o estado de antes, sem pódio, e só recarregando a página ele aparecia. Pior: como nada mudava na tela, dava a impressão de que o placar não tinha gravado, e a pessoa lançava de novo. Agora, <b>lançou, a tela redesenha na hora</b>: o placar entra, a chave avança e o pódio (🥇🥈🥉) aparece sozinho.</li>' +
        '<li><b>📣 Novidades enche a linha, como os últimos resultados:</b> quando cada jogo novo vinha de um <b>grupo diferente</b>, a seção mostrava <b>um card só</b> e deixava o resto da linha vazio — o rótulo do grupo ocupava a linha inteira sozinho, para um único jogo. Agora, grupo com um jogo só leva o rótulo <b>dentro do card</b>, e a linha se enche: cabem dois, aparecem dois; cabem três, aparecem três. Grupo com vários jogos continua com o rótulo uma vez só, no topo.</li>' +
        '<li><b>👥 Lista de inscritos que aparecia vazia:</b> com um filtro de <b>gênero</b> ou <b>nível</b> ligado, quem ainda não tem esse dado preenchido — como as vagas "Jogador 01, 02…" que o organizador cria antes do sorteio — <b>sumia da tela</b>, mesmo com o contador dizendo que havia gente ali. Filtrar por ♂ quer dizer "me mostre os homens"; uma vaga em branco não é o oposto disso, é <b>desconhecido</b>, e agora ela continua aparecendo. E se algum filtro esconder todo mundo, a tela passa a <b>dizer quantos estão ocultos</b> e como vê-los, em vez de ficar em branco sem explicação.</li>' +
        '<li><b>🔎 A busca da chave encontra qualquer pessoa, em qualquer grupo:</b> procurar pelo nome de alguém só achava <b>o seu próprio jogo</b> — digitar as letras de outra pessoa não trazia nada e a chave sumia da tela. Para abrir rápido, o app monta os grupos <b>aos poucos</b> e busca o nome de cada participante no perfil; os grupos que ainda não tinham aparecido entravam <b>sem nome nenhum</b>, e ninguém os buscava depois — então não havia o que encontrar. Agora, ao procurar, o app termina de montar a chave e <b>vai buscar os nomes que faltam</b> antes de filtrar. Funciona com o nome inteiro, com parte dele e com duas palavras.</li>' +
        '<li><b>🔎 Procurar alguém na chave agora acha mesmo — por nome ou por parte dele:</b> digitar o nome de um participante <b>apagava a chave inteira</b> em vez de mostrar os jogos dele. O app guarda a <b>identidade</b> de quem tem conta e busca o nome no perfil na hora de desenhar — assim quem troca de nome aparece atualizado em todo lugar. Só que o texto usado pela <b>busca</b> era montado antes de o perfil chegar, e ficava <b>sem o nome da pessoa</b>: procurar por ela não encontrava nada, e a tela escondia tudo. Agora o nome entra na busca assim que o perfil carrega. Vale para pedaços do nome (<b>“rib”</b> acha <b>Ana Ribeiro</b>) e para duas palavras (<b>“ana rib”</b>).</li>' +
        '<li><b>🔎 A busca da chave voltou a achar — e parou de apagar a tela:</b> procurar um nome dentro do torneio <b>sumia com a chave inteira</b>, sem nem dizer “nenhum jogo encontrado”. A mesma busca funcionava na lista de inscritos, e a diferença era o motivo: para abrir rápido, a chave monta os grupos <b>por partes</b>, e a busca só montava a primeira camada — os jogos que moravam mais adentro <b>nunca entravam na tela</b>, então nada era encontrado e tudo era escondido. Agora a busca monta todas as camadas antes de filtrar: digitar um nome mostra os jogos daquela pessoa, esteja ela em que grupo estiver.</li>' +
        '<li><b>📋 A lista de espera agora mostra também inativos e W.O.:</b> quem está fora da fase aparecia em lugar nenhum. Abaixo de quem está esperando, o organizador passa a ver duas faixas — <b>💤 Inativos</b> e <b>🚫 W.O.</b> —, cada uma com a contagem. Quem reativar entra no <b>fim da lista de espera</b>, como já acontecia.</li>' +
        '<li><b>⏱️ A configuração de inscrições da fase virou atalho na própria chave:</b> na tela do torneio havia um único interruptor que misturava duas decisões diferentes — e desligá-lo pulava direto para <b>“inscrições encerradas”</b>, sem deixar escolher o meio-termo. Agora as duas aparecem separadas, com os <b>mesmos nomes da tela de edição</b>: <b>Fechadas</b> (ninguém mais entra) e <b>Novos Confrontos</b> (a espera abre confronto novo) — desligada esta, a lista de espera fica <b>só de suplentes</b>. Serve de atalho e de lembrete de como a fase está configurada.</li>' +
        '<li><b>🔢 O número de inscrição parou de aparecer errado:</b> quem se inscreveu com o torneio já em andamento aparecia como <b>“inscrito 24”</b> num torneio com <b>mais de 150 pessoas</b>. O número é a posição na ordem de inscrição, e ele era calculado sobre a <b>parte</b> da lista que já tinha carregado. Pior: essa mesma conta <b>gravava</b> a posição de cada um — feita sobre meia lista, embaralharia a numeração de todo mundo. Agora, enquanto a lista não chegou inteira, o card aparece <b>sem número</b> em vez de um errado, e nada é gravado.</li>' +
        '<li><b>🙍 Inscrito sem nome no card:</b> na área de formar duplas, alguém aparecia <b>só com a foto</b>, sem nome nenhum — mesmo tendo conta e perfil. O nome é sempre buscado pelo perfil da pessoa (para acompanhar quem troca de nome), mas o card não tinha como saber de quem se tratava e ficava mudo para sempre. Agora ele descobre a pessoa e o nome aparece — e continua acompanhando o perfil.</li>' +
        '<li><b>🚪 “Aceitar entradas tardias” desligado agora vale de verdade:</b> com a opção <b>desligada</b> na fase, quem estava esperando continuava aparecendo na área de <b>formar novas duplas</b> — ou seja, o app ainda oferecia criar confronto novo numa fase em que o organizador tinha fechado essa porta. Agora, desligada, essas pessoas ficam na <b>lista de espera</b>, como deveria.</li>' +
        '<li><b>🔎 Buscar por duas palavras voltou a achar:</b> na busca da chave, escrever <b>“ana r”</b> fazia <b>tudo sumir</b> — parecia que a pessoa não estava no torneio. A busca procurava o trecho exatamente como você digitou, e bastava ele cair entre dois nomes (a barra da dupla, o segundo nome) para não existir. Agora <b>cada palavra é procurada por conta própria</b>: “ana r” e até “rib” acham <b>Ana Ribeiro</b>, e “ribeiro andreya” acha a dupla das duas, mesmo fora de ordem.</li>' +
        '<li><b>🗣️ O app parou de presumir o gênero de quem você cadastra:</b> ao registrar o celular de um participante, o aviso dizia <b>“fulano foi avisada”</b> — errado para metade das pessoas. Esses textos foram reescritos para não depender de gênero nenhum: agora é <b>“Avisamos fulano de que você registrou o celular”</b>. O mesmo vale para o convite de substituto, o convite de arbitragem e a ficha de desempenho.</li>' +
        '<li><b>🔤 O cabeçalho do grupo cabe em duas linhas:</b> em telas estreitas, <b>“R1 Grupo C”</b> quebrava em <b>três linhas</b> espremido ao lado dos botões, o selo <b>Concluído</b> aparecia cortado por cima do nome e os botões esticavam numa altura enorme só para acompanhar. Agora o grupo aparece como <b>“R1 (C)”</b> numa linha e o <b>Concluído</b> inteiro na linha de baixo, em letra menor — e os botões voltam à altura normal.</li>' +
        '<li><b>🔎 O filtro da lista de torneios voltou a filtrar:</b> digitar na busca da lista simplesmente <b>não fazia nada</b> — parecia que nenhum torneio combinava. A busca guardava os cards uma vez e, quando a tela se atualizava sozinha (o que acontece a cada dado que chega), passava a esconder e mostrar cards que <b>já não estavam mais na tela</b>. Agora ela relê a lista a cada letra digitada, e é a <b>mesma barra de busca</b> das outras telas, em vez de uma feita à parte.</li>' +
        '<li><b>🔢 O número do jogo é o mesmo na tela inicial e na chave:</b> o mesmo confronto podia aparecer como <b>Jogo 168</b> na tela inicial e <b>Jogo 169</b> na chave. O número é contado na ordem dos jogos, e a tela inicial contava sobre uma <b>parte</b> do torneio — ela carrega um resumo, e o torneio inteiro só chega ao abrir. Isso dava um número menor, com toda a cara de certo. Agora a contagem só acontece com o torneio <b>completo</b>: enquanto ele está chegando, o card fica <b>sem número</b> em vez de mostrar um errado, e o número aparece assim que termina de carregar.</li>' +
        '<li><b>🎾 Melhor de 3 e melhor de 5 aparecem também na tela inicial:</b> os cards de jogo da tela inicial mostravam <b>um número só</b>, sem dizer que a partida era melhor de 3 nem quantos sets tinha. Agora trazem <b>“Melhor de 3 · Set 1”</b> e <b>uma coluna por set</b>, igual à chave — nos três lugares onde um jogo aparece: seu próximo jogo, novidades e seus últimos resultados. O card do seu próximo jogo também ganhou a <b>mesma largura</b> dos demais.</li>' +
        '<li><b>ℹ️ A versão do app agora aparece em todas as telas:</b> ela só existia na tela inicial, acima de “novo torneio”. Passou para <b>logo abaixo do nome scoreplace.app</b>, no alto da tela — visível em qualquer lugar do app, útil pra conferir se você já está na versão nova.</li>' +
        '<li><b>🏆 Abrir um torneio continua abrindo o torneio:</b> uma atualização tardia da chamada podia repintar a lista de inscritos por cima do detalhe, deixando sorteio, edição, configurações e exclusão inacessíveis. Agora a lista só pode se redesenhar enquanto você ainda está nela.</li>' +
        '<li><b>📋 Quem organiza vê primeiro o que falta fechar:</b> no detalhe do torneio, o organizador passa a ver os grupos <b>pendentes na frente</b> e os já realizados depois — e na <b>ordem do sorteio</b>: A até Z, depois A2 até Z2, e assim por diante. Antes a lista era alfabética, o que jogava o A2 logo depois do A1, no meio da primeira volta. Para quem <b>joga</b> nada muda: continua a agenda de sempre, com o seu grupo primeiro.</li>' +
        '<li><b>🎾 Jogo confirmado que voltava a aparecer vazio (0-0):</b> resultados já lançados e aprovados podiam reaparecer <b>sem placar e sem vencedor</b>, como se ninguém tivesse jogado — bastava alguém lançar o placar de novo por cima. O resultado <b>nunca foi perdido</b>: ele estava guardado o tempo todo; era a tela que o apagava ao desenhar. Dois acertos: uma proposta de placar não apaga mais um resultado já confirmado, e <b>confirmado não volta a ficar pendente</b> — quem confirmou já respondeu, e o pedido de confirmação sai da tela. E a garantia mudou de lugar: quem grava o resultado agora é o <b>servidor</b>, na mesma operação em que ele aplica o placar. Antes cada celular mandava a sua cópia, e um aparelho com a tela desatualizada conseguia empurrar o estado antigo dele por cima do resultado de todo mundo — era isso que fazia o jogo "desconfirmar" sozinho.</li>' +
        '<li><b>▶️ Tocar uma partida antiga agora REPRODUZ o jogo:</b> em <b>Partida casual → Últimas Partidas</b>, o toque no card abria direto o placar final. Agora ele reproduz a partida ponto a ponto, no <b>mesmo placar ao vivo</b> em que ela foi jogada — com a virada de cada game, o saque trocando de lado e o tie-break — e termina exatamente na tela de estatísticas que aparecia antes. O que você via continua lá: virou o fim do caminho, em vez do começo. Partidas antigas demais para terem o registro ponto a ponto seguem abrindo as estatísticas direto.</li>' +
      '</ul></div>' +
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>🎾 Os dois times lançavam o mesmo placar e ninguém podia aprovar:</b> quando as duas duplas mandavam o resultado quase ao mesmo tempo, cada celular passava a mostrar o <b>próprio dono</b> como quem lançou — e como ninguém aprova a própria proposta, o jogo ficava pendente até o organizador entrar. Agora o segundo lançamento não passa por cima do primeiro — e, melhor: se os <b>dois times lançaram o mesmo placar</b>, isso é acordo, não conflito, e o jogo é <b>confirmado na hora, sem precisar de aprovação</b>. Só quando os placares <b>divergem</b> é que vale a corrida: fica o primeiro, e o segundo recebe a proposta do outro com Confirmar, Editar e Contestar.</li>' +
        '<li><b>🔴 O jogo cancelado no meio some do "Ao vivo agora":</b> uma partida encerrada por dentro do app continuava anunciada como ao vivo, sem hora para sair. O sinal que a mantinha na vitrine parava só quando o jogo terminava normalmente — agora fechar o placar já tira o jogo da lista.</li>' +
        '<li><b>🔔 As notificações param de voltar ao topo enquanto você lê:</b> depois de 5 segundos na tela o aviso é dado como lido, e era essa marcação que fazia a lista se redesenhar e jogar a rolagem para o começo. Agora só um aviso <b>novo</b> redesenha a lista — e mesmo aí você continua no ponto onde estava.</li>' +
        '<li><b>📍 Sua presença não aparece mais duplicada:</b> quem fazia check-in num local onde também tinha plano de ir via as duas linhas ao mesmo tempo ("Você está em" e "Você estará em", o mesmo clube). Chegar agora responde o plano, e fica uma linha só. O cartão de <b>Agora no local</b> também ficou mais simples: nome e legenda numa linha cada, o ✕ no fim, e o cartão ocupando a largura toda em vez de espremido em meia tela.</li>' +
        '<li><b>⚖️ Novo critério de desempate — saldo de pontos de tie-break:</b> até aqui a classificação olhava o saldo de <b>games</b>, mas nunca o placar <b>dentro</b> do tie-break: perder por 5-7 valia o mesmo que perder por 0-7. São pontos disputados em quadra que não estavam sendo contados. Agora eles contam, <b>logo depois do saldo de games</b> — e bem antes do sorteio, então há muito menos empate decidido pela ordem da chave.</li>' +
        ...
        '<li><b>📂 Torneio grande parou de travar:</b> a tela inicial passou a ler um resumo do torneio em vez do torneio inteiro, e a chave nasce com o seu grupo primeiro. Torneios com dezenas de grupos abrem sem a espera que existia antes. E os <b>torneios existentes</b> passaram a guardar inscritos e jogos separadamente, cada um no seu lugar: é o que tira o limite de tamanho e faz lançar um placar mexer só naquele jogo, em vez de reescrever o torneio inteiro.</li>' +
        ...
        '<li><b>📏 Seções que você abre e fecha, do seu jeito:</b> a previsão mostra agora e hoje (os próximos dias abrem em <b>Próximos dias</b>); o progresso mostra a rodada (a barra do torneio inteiro abre em <b>Torneio completo</b>); e a caixa de <b>configuração</b> do torneio ganhou o mesmo controle. O app lembra o que você deixou aberto ou fechado — na tela inicial e no detalhe.</li>' +
        '<li><b>🤝 Convite fantasma não volta mais:</b> quando duas contas suas eram unidas, convites antigos podiam reaparecer ao lado de amizades já aceitas. A regra agora é uma só e vale no app e no servidor: se a pessoa já é sua amiga, não existe convite pendente com ela.</li>' +
        '<li><b>🔀 Os filtros de torneio voltaram:</b> Pra Você, Organizados, Participando, Inscrições Abertas, Favoritos e Encerrados estão de novo na tela inicial — agora como uma faixa fina de botões, e não mais como o quadro grande que ocupava o topo.</li>' +
        '<li><b>➡️ "Ir para o torneio" leva ao grupo que você clicou:</b> nas Novidades, o botão levava sempre ao seu próprio grupo, e a seção chegava fechada. Agora ele para no topo do grupo indicado, com a seção já aberta.</li>' +
        '<li><b>🎯 A tela para de pular quando você lança placar:</b> a cada resultado confirmado a chave saltava sozinha para outro ponto — normalmente para "Demais jogos da rodada". Agora ela fica exatamente onde está: a rolagem automática só acontece quando é você que pede.</li>' +
        '<li><b>🔤 Os nomes cabem inteiros:</b> nas listas de pessoas o nome vinha cortado ("Fernando Bernacchi" virava "Fernar Bernac…"). O rótulo "✓ Amigos" saiu (a cor verde já diz que é amigo) e responder a um convite virou dois botões redondos ✓/✕ no lugar de "Aceitar"/"Rejeitar" escritos — os dois roubavam a largura do nome. As listas agora abrem em 3 colunas em tela larga, com o nome legível.</li>' +
        '<li><b>🤝 Quem já é seu amigo sai dos convites pendentes:</b> alguns amigos continuavam aparecendo na lista de convites, como se a amizade não tivesse sido aceita. Agora, se a pessoa já é sua amiga, ela nunca aparece como convite — em nenhuma tela.</li>' +
        '<li><b>📐 Todas as listas de pessoas dividem a tela igual:</b> amigos, convites recebidos, convites enviados e a tela Explorar usam exatamente o mesmo formato — se os amigos aparecem em 3 colunas, os convites também. E a cor diz o estado: verde para amigo, âmbar para convite pendente. O ✕ de desfazer amizade, que era cinza e quase invisível, virou o mesmo círculo vermelho de cancelar do resto do app.</li>' +
        '<li><b>🟢 Quem já é seu amigo aparece como amigo:</b> na tela Explorar, os amigos agora vêm em verde com o selo <b>✓ Amigos</b> — antes o app oferecia convidá-los de novo. E o botão de cancelar convite passou a usar o ✕ branco no círculo vermelho, o mesmo símbolo de cancelar do resto do app, aqui e na tela de amigos.</li>' +
        '<li><b>🔙 Convidar alguém não tira mais você da tela:</b> ao convidar um amigo dentro do Explorar, o app voltava sozinho para a lista de amigos. Agora você fica onde está até clicar em Voltar — e o botão do cabeçalho voltou a dizer <b>Voltar</b>, em vez do nome da própria tela.</li>' +
        '<li><b>👥 A tela de Pessoas virou a SUA lista:</b> agora ela mostra seus amigos em ordem alfabética e, logo abaixo, os convites ainda não aceitos. Para conhecer gente nova há um botão <b>Explorar</b> com o total de pessoas — ele abre uma tela própria que começa por <b>quem joga nos seus locais preferidos</b> e depois o resto, com ordenar, filtrar e buscar. De quebra, abrir Pessoas ficou bem mais rápido: a lista de desconhecidos só é carregada quando você pede.</li>' +
        '<li><b>🧼 A tela inicial ficou mais limpa:</b> o quadro de números do topo (Pra Você, Organizados, Participando, Usuários, Amigos, Partidas) saiu. As informações que valerem a pena voltam distribuídas onde fazem sentido.</li>' +
