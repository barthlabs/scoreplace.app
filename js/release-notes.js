  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🔎 Buscar um jogador agora mostra o contexto inteiro:</b> encontrar alguém — inclusive um <b>Jogador X</b> — mantém visíveis o grupo, a classificação, todos os jogos daquela rodada e os registros de espera, inativo e W.O. O número em <b>Demais jogos da rodada</b> voltou a informar o total real da seção, sem virar zero por causa do filtro.</li>' +
