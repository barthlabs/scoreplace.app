  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🏆 Abrir um torneio abre a ficha dele:</b> tocar o card na tela inicial não joga mais a pessoa na chamada. A ficha mostra as informações e as ferramentas do torneio e, logo abaixo de quem organiza, os <b>cards dos inscritos</b>. Presença, filtros e W.O. continuam acessíveis pelo botão <b>Inscritos</b>, na sua tela própria.</li>' +
