  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        ...
        '<li><b>🔴 A tela de avançar fase agora mostra <i>todo mundo</i> que fica de fora — inclusive os W.O.:</b> ao avançar, ela avisava só sobre quem <b>desativou a participação</b>. Quem <b>levou W.O.</b> também não entra no sorteio da próxima fase, e simplesmente não era mencionado — o organizador só descobria depois, olhando a chave. Agora as duas listas aparecem, com os <b>nomes em vermelho</b>, do mesmo jeito que já aparecem nas listas do torneio. <b>Nada mudou nas regras:</b> quem levou W.O. continua inscrito e desativado, e a escolha (<b>incluir</b> ou <b>excluir</b>) segue valendo só para quem desativou a participação — ela nunca alcançou, e continua não alcançando, quem levou W.O.</li>' +
