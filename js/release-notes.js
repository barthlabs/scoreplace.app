  ...
  var html =
    ...
    '<div style="margin-bottom:1rem;border:2px solid #fbbf24;border-radius:12px;padding:14px 16px;background:rgba(251,191,36,0.08);">' +
      ...
      '<ul style="margin:0; padding-left:1.1rem; font-size:0.86rem; line-height:1.5; color:var(--text-main);">' +
        '<li><b>👤 O card do organizador ficou do mesmo tamanho dos demais:</b> na tela do torneio, o cartão de quem organiza ocupava a <b>linha inteira</b> enquanto os inscritos apareciam dois por linha. Eram duas regras de layout diferentes para a mesma coisa; agora é uma só, e todo card de pessoa tem a mesma largura.</li>' +
