...
// A fronteira termina no próximo subsistema. A rotina histórica de recuperação de
// adminEmails saiu: usá-la como sentinela fazia este teste incluir o resto do store
// e encontrar atribuições de status que não pertencem ao fechamento automático.
const boot = s.slice(s.indexOf('window._autoCloseExpiredEnrollments = function'), s.indexOf('// ─── Temas:', s.indexOf('window._autoCloseExpiredEnrollments = function')));
