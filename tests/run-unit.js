...
const SUITES = [
  ...
  'tests/placar-grade-canonica-todas-telas.test.js',
  ...
  'tests/email-do-organizador-so-para-o-elenco.test.js',
  'tests/aviso-exclui-por-uid-e-por-email.test.js',
  'tests/card-do-resumo-conta-pelo-contador.test.js',
  'tests/omitir-nao-apaga-precisa-de-sentinela.test.js',
  'tests/convite-de-amigos-nao-baixa-contatos.test.js',
  'tests/analise-de-inscritos-usa-porta-restrita.test.js',
  'tests/fusao-do-login-usa-porta-restrita.test.js',
  'tests/foto-da-chave-nao-abre-a-ficha.test.js',
  'tests/presencas-de-amigos-nao-abrem-ficha-privada.test.js',
  ...
  'tests/acesso-sem-senha-removido.test.js',
  ...
  'tests/aviso-ao-organizador-e-por-uid.test.js',
  ...
  // A sincronização administrativa é uma fotografia parcial. No sandbox dividido ela
  // não pode recalcular as partes nem transformar ausência em delete de inscritos/jogos.
  'tests/sandbox-sync-nao-apaga-partes.test.js',
  ...
  'tests/doc-publico-nao-carrega-email.test.js',
  ...
  'tests/ver-menos-acompanha-a-rolagem.test.js',
  'tests/ouvinte-de-jogos-segue-a-tela-aberta.test.js',
  'tests/podio-concorda-com-a-classificacao.test.js',
  ...
  'tests/classificacao-anterior-fica-compacta.test.js',
  'tests/cabecalho-e-busca-fixos-no-celular.test.js',
  'tests/hidratacao-nao-congela-no-primeiro-quadro.test.js',
  'tests/resultados-espelhados-hidratam-telas.test.js',
  'tests/rodada-tem-numero-global-no-torneio.test.js',
  'tests/aborto-da-transacao-nao-vira-sucesso.test.js',
  ...
  'tests/presenca-nao-cai-na-chave-nome.test.js',
  ...
  'tests/wo-chega-nas-subcolecoes.test.js',
  ...
  'tests/wo-organizer-actions.test.js',
  ...
  'tests/descoberta-publica-sem-queda-silenciosa.test.js',
  'tests/rotacao-nao-faz-o-trabalho-duas-vezes.test.js',
  ...
  'tests/criar-enquete-cf-only.test.js', // L7: criação e aviso de enquete só passam pela Function
  'tests/reabrir-vagas-cf-only.test.js', // L7: meta de vagas só passa pela Function
  // L7: encerramento manual só passa pela Function
  'tests/encerrar-torneio-cf-only.test.js',
  'tests/inscricoes-e-sorteio-vagas-cf-only.test.js', // L7: encerramento manual só passa pela Function
  ...
  'functions/test-profile-contact-privacy-core.js',
  'functions/test-profile-live-alerts-core.js',
  ...
  'functions/test-casual-scoring-preferences-core.js',
  ...
  // Quem escurece a tela é o coachmarks.js; o teste cobre a proteção contra
  // placar ao vivo no sistema de dicas efetivamente carregado. Roda o
  ...
  'tests/navegacao-preserva-tela-na-troca.test.js',
  ...
  'tests/formato-sobe-e-linha-do-tempo-desce-no-card.test.js',
