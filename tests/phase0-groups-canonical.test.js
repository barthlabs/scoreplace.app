...
// ── MODO Rei/Rainha na fase 0 → parceiro rotativo, avanço por INDIVÍDUO ────────
(function () {
  ...
  buildPhase0(t, cfg0);
  ok((t.matches || []).some(function (m) { return m.isMonarch && (m.phaseIndex || 0) === 0; }), 'Rei/Rainha fase 0 → t.matches taggeado isMonarch (modo, não formato)');
  var rec = E.prevPhaseGroups(t);
  ...
  decideAll(t);
  ok(E.phaseComplete(t) === true, 'phaseComplete=true (monarca taggeado, 1 rodada)');
