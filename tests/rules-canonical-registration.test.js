...
out.directDelete=await req('DELETE','tournaments/t1/registrations/uid_atleta__skill-b',uid);
...
ok(out.directDelete===403,'Rules negam remoção direta de registro canônico');
