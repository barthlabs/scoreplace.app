...
r=transition(t,{action:'resolve',uid:'org',isAdmin:true,claimId:'c',context:c}); ok(r.ok&&r.apply&&r.forceWaitlistSub,'organizador aplica W.O. direto e promove a espera');
